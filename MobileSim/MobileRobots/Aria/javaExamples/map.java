...
public class map {
  ...
  public static void main(String argv[]) {
    ...
    //System.out.println("Will be able to load maps from the c++ examples directory: ../examples.");
    //ArMap map = new ArMap("../examples/");
    ArMap map = new ArMap();
    System.out.println("loading map: ../examples/columbia.map");
    if(!map.readFile("../examples/columbia.map"))
    {
        System.out.println("Error loading map.");
    }
    else
    {
        //System.out.println("writing map: out.map in ../examples directory");
