# Microsoft Developer Studio Project File - Name="AriaPy" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Dynamic-Link Library" 0x0102

CFG=AriaPy - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "AriaPy.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "AriaPy.mak" CFG="AriaPy - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "AriaPy - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "AriaPy - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
# ADD CPP /nologo /W3 /GR /GX /O2 /I "../include" /I "$(PYTHON_INCLUDE)" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ARIA_STATIC" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 wsock32.lib winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib "$(PYTHON_LIB)" /nologo /version:0.7 /dll /pdb:none /machine:I386 /out:"_AriaPy.dll"

!ELSEIF  "$(CFG)" == "AriaPy - Win32 Debug"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "AriaPy___Win32_Debug"
# PROP BASE Intermediate_Dir "AriaPy___Win32_Debug"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
...
# ADD CPP /nologo /MTd /W3 /GR /GX /Zi /Od /I "../include" /I "$(PYTHON_INCLUDE)" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ARIA_STATIC" /FR /FD /GZ /c
# SUBTRACT CPP /YX
...
# ADD LINK32 wsock32.lib winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib "$(PYTHON_LIB)" /nologo /version:0.7 /dll /pdb:none /debug /machine:I386 /nodefaultlib:"python22_d.lib" /out:"_AriaPy.dll"

!ENDIF 

# Begin Target

# Name "AriaPy - Win32 Release"
# Name "AriaPy - Win32 Debug"
...
"..\python\AriaPy_wrap.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	echo In order to function correctly, please ensure the following environment variables are correctly set: 
	echo PYTHON_INCLUDE: %PYTHON_INCLUDE% 
	echo PYTHON_LIB: %PYTHON_LIB% 
	echo Also make sure swig is in your Options/Directories/"Executable Files" 
	echo on 
	cd ..\python 
	swig -c++ -python -DAREXPORT -module AriaPy -o AriaPy_wrap.cpp $(InputPath) 
...
"..\python\AriaPy_wrap.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	echo This does not work in DEBUG mode 
	del ..\python\AriaPy_wrap.cpp 
