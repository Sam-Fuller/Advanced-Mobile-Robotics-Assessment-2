...
class ArServerBase(AriaPy.ArASyncTask):
    ...
    __repr__ = _swig_repr
    def __init__(self, addAriaExitCB = True, serverName = "", addBackupTimeoutToConfig = True, 
    backupTimeoutName = "RobotToClientTimeoutInMins", 
    ...
    masterServer = False, 
    slaveServer = False, 
    logPasswordFailureVerbosely = False, 
    allowSlowPackets = True, 
    allowIdlePackets = True): 
        """
        ...
        """
        this = _ArNetworkingPy.new_ArServerBase(addAriaExitCB, serverName, addBackupTimeoutToConfig, 
    backupTimeoutName, backupTimeoutDesc, masterServer, 
    slaveServer, logPasswordFailureVerbosely, 
    allowSlowPackets, allowIdlePackets)
        try: self.this.append(this)
        except: self.this = this
...
class ArClientBase(AriaPy.ArASyncTask):
    ...
    def blockingConnect(self, *args):
        """
        blockingConnect(self, char host, int port, bool _print = True, char user = None, 
            char password = None, char openOnIP = None) -> bool
        blockingConnect(self, char host, int port, bool _print = True, char user = None, 
            char password = None) -> bool
        blockingConnect(self, char host, int port, bool _print = True, char user = None) -> bool
        blockingConnect(self, char host, int port, bool _print = True) -> bool
    ...
    def setServerKey(self, *args):
        """
        setServerKey(self, char serverKey, bool _print = True)
        setServerKey(self, char serverKey)
        """
    ...
    def internalBlockingConnect(self, *args):
        """
        internalBlockingConnect(self, char host, int port, bool _print, char user, char password, 
    ...
    def internalNonBlockingConnectStart(self, *args):
        """
        internalNonBlockingConnectStart(self, char host, int port, bool _print, char user, char password, 
...
class ArClientSimpleConnector(_object):
    ...
    def connectClient(self, *args):
        """
        connectClient(self, ArClientBase client, bool _print = True) -> bool
