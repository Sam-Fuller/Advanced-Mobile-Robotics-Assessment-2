...
class ArPoseWithTimeVector(_object):
...
class ArSensorReadingVector(_object):
...
class ArMapObjectPtrList(_object):
...
class ArFunctorPtrList(_object):
...
class ArPoseWithTimeList(_object):
...
class ArPoseWithTimePtrList(_object):
...
class ArRangeDevicePtrList(_object):
...
class ArArgumentBuilderPtrList(_object):
...
class ArLineSegmentList(_object):
...
class ArLineSegmentPtrList(_object):
...
class ArUtil(_object):
    ...
    if _newclass:getTime = staticmethod(getTime)
    __swig_getmethods__["getTime"] = lambda x: getTime
    def findMin(*args):
        """
    ...
    if _newclass:findMin = staticmethod(findMin)
    __swig_getmethods__["findMin"] = lambda x: findMin
    def findMax(*args):
        """
    ...
    if _newclass:findMax = staticmethod(findMax)
    __swig_getmethods__["findMax"] = lambda x: findMax
    def sizeFile(*args):
        """
    ...
    if _newclass:sizeFile = staticmethod(sizeFile)
    __swig_getmethods__["sizeFile"] = lambda x: sizeFile
    def findFile(*args):
        """findFile(char fileName) -> bool"""
        return _AriaPy.ArUtil_findFile(*args)

    if _newclass:findFile = staticmethod(findFile)
    __swig_getmethods__["findFile"] = lambda x: findFile
    ...
    if _newclass:appendSlash = staticmethod(appendSlash)
    __swig_getmethods__["appendSlash"] = lambda x: appendSlash
    def fixSlashes(*args):
        """
    ...
    if _newclass:fixSlashes = staticmethod(fixSlashes)
    __swig_getmethods__["fixSlashes"] = lambda x: fixSlashes
    def fixSlashesForward(*args):
        """fixSlashesForward(char path, size_t pathLength)"""
        return _AriaPy.ArUtil_fixSlashesForward(*args)

    if _newclass:fixSlashesForward = staticmethod(fixSlashesForward)
    __swig_getmethods__["fixSlashesForward"] = lambda x: fixSlashesForward
    def fixSlashesBackward(*args):
        """fixSlashesBackward(char path, size_t pathLength)"""
        return _AriaPy.ArUtil_fixSlashesBackward(*args)

    if _newclass:fixSlashesBackward = staticmethod(fixSlashesBackward)
    __swig_getmethods__["fixSlashesBackward"] = lambda x: fixSlashesBackward
    def getSlash():
        """getSlash() -> char"""
        return _AriaPy.ArUtil_getSlash()

    if _newclass:getSlash = staticmethod(getSlash)
    __swig_getmethods__["getSlash"] = lambda x: getSlash
    ...
    if _newclass:addDirectories = staticmethod(addDirectories)
    __swig_getmethods__["addDirectories"] = lambda x: addDirectories
    def strcmp(*args):
        """
    ...
    if _newclass:strcmp = staticmethod(strcmp)
    __swig_getmethods__["strcmp"] = lambda x: strcmp
    def strcasecmp(*args):
        """
    ...
    if _newclass:strcasecmp = staticmethod(strcasecmp)
    __swig_getmethods__["strcasecmp"] = lambda x: strcasecmp
    def strcasequotecmp(*args):
        """strcasequotecmp(string str1, string str2) -> int"""
        return _AriaPy.ArUtil_strcasequotecmp(*args)

    if _newclass:strcasequotecmp = staticmethod(strcasequotecmp)
    __swig_getmethods__["strcasequotecmp"] = lambda x: strcasequotecmp
    def escapeSpaces(*args):
        """escapeSpaces(char dest, char src, size_t maxLen)"""
        return _AriaPy.ArUtil_escapeSpaces(*args)

    if _newclass:escapeSpaces = staticmethod(escapeSpaces)
    __swig_getmethods__["escapeSpaces"] = lambda x: escapeSpaces
    def stripQuotes(*args):
        """stripQuotes(char dest, char src, size_t destLen) -> bool"""
        return _AriaPy.ArUtil_stripQuotes(*args)

    if _newclass:stripQuotes = staticmethod(stripQuotes)
    __swig_getmethods__["stripQuotes"] = lambda x: stripQuotes
    def lower(*args):
    ...
    if _newclass:isOnlyAlphaNumeric = staticmethod(isOnlyAlphaNumeric)
    __swig_getmethods__["isOnlyAlphaNumeric"] = lambda x: isOnlyAlphaNumeric
    def isOnlyNumeric(*args):
        """isOnlyNumeric(char str) -> bool"""
        return _AriaPy.ArUtil_isOnlyNumeric(*args)

    if _newclass:isOnlyNumeric = staticmethod(isOnlyNumeric)
    __swig_getmethods__["isOnlyNumeric"] = lambda x: isOnlyNumeric
    def isStrEmpty(*args):
        """isStrEmpty(char str) -> bool"""
        return _AriaPy.ArUtil_isStrEmpty(*args)

    if _newclass:isStrEmpty = staticmethod(isStrEmpty)
    __swig_getmethods__["isStrEmpty"] = lambda x: isStrEmpty
    ...
    if _newclass:isStrInList = staticmethod(isStrInList)
    __swig_getmethods__["isStrInList"] = lambda x: isStrInList
    def atof(*args):
        """atof(char nptr) -> double"""
        return _AriaPy.ArUtil_atof(*args)

    if _newclass:atof = staticmethod(atof)
    __swig_getmethods__["atof"] = lambda x: atof
    def convertBool(*args):
        """convertBool(int val) -> char"""
        return _AriaPy.ArUtil_convertBool(*args)

    if _newclass:convertBool = staticmethod(convertBool)
    __swig_getmethods__["convertBool"] = lambda x: convertBool
    def writeToFile(*args):
        """writeToFile(char str, FILE file)"""
        return _AriaPy.ArUtil_writeToFile(*args)

    if _newclass:writeToFile = staticmethod(writeToFile)
    __swig_getmethods__["writeToFile"] = lambda x: writeToFile
    ...
    if _newclass:getStringFromFile = staticmethod(getStringFromFile)
    __swig_getmethods__["getStringFromFile"] = lambda x: getStringFromFile
    ...
    if _newclass:getStringFromRegistry = staticmethod(getStringFromRegistry)
    __swig_getmethods__["getStringFromRegistry"] = lambda x: getStringFromRegistry
    ...
    if _newclass:FALSESTRING = _swig_property(_AriaPy.ArUtil_FALSESTRING_get, _AriaPy.ArUtil_FALSESTRING_set)
    def putCurrentYearInString(*args):
        """putCurrentYearInString(char s, size_t len)"""
        return _AriaPy.ArUtil_putCurrentYearInString(*args)

    if _newclass:putCurrentYearInString = staticmethod(putCurrentYearInString)
    __swig_getmethods__["putCurrentYearInString"] = lambda x: putCurrentYearInString
    ...
    if _newclass:putCurrentMonthInString = staticmethod(putCurrentMonthInString)
    __swig_getmethods__["putCurrentMonthInString"] = lambda x: putCurrentMonthInString
    def putCurrentDayInString(*args):
        """putCurrentDayInString(char s, size_t len)"""
        return _AriaPy.ArUtil_putCurrentDayInString(*args)

    if _newclass:putCurrentDayInString = staticmethod(putCurrentDayInString)
    __swig_getmethods__["putCurrentDayInString"] = lambda x: putCurrentDayInString
    def putCurrentHourInString(*args):
        """putCurrentHourInString(char s, size_t len)"""
        return _AriaPy.ArUtil_putCurrentHourInString(*args)

    if _newclass:putCurrentHourInString = staticmethod(putCurrentHourInString)
    __swig_getmethods__["putCurrentHourInString"] = lambda x: putCurrentHourInString
    ...
    if _newclass:putCurrentMinuteInString = staticmethod(putCurrentMinuteInString)
    __swig_getmethods__["putCurrentMinuteInString"] = lambda x: putCurrentMinuteInString
    ...
    if _newclass:putCurrentSecondInString = staticmethod(putCurrentSecondInString)
    __swig_getmethods__["putCurrentSecondInString"] = lambda x: putCurrentSecondInString
    def parseTime(*args):
        """
    ...
    if _newclass:parseTime = staticmethod(parseTime)
    __swig_getmethods__["parseTime"] = lambda x: parseTime
    def localtime(*args):
        """
    ...
    if _newclass:localtime = staticmethod(localtime)
    __swig_getmethods__["localtime"] = lambda x: localtime
    ...
    if _newclass:changeFileTimestamp = staticmethod(changeFileTimestamp)
    __swig_getmethods__["changeFileTimestamp"] = lambda x: changeFileTimestamp
    def fopen(*args):
        """
    ...
    if _newclass:fopen = staticmethod(fopen)
    __swig_getmethods__["fopen"] = lambda x: fopen
    def open(*args):
        """
    ...
    if _newclass:creat = staticmethod(creat)
    __swig_getmethods__["creat"] = lambda x: creat
    def popen(*args):
        """
    ...
    if _newclass:popen = staticmethod(popen)
    __swig_getmethods__["popen"] = lambda x: popen
    ...
    if _newclass:setFileCloseOnExec = staticmethod(setFileCloseOnExec)
    __swig_getmethods__["setFileCloseOnExec"] = lambda x: setFileCloseOnExec
    def floatIsNormal(*args):
        """floatIsNormal(double f) -> bool"""
        return _AriaPy.ArUtil_floatIsNormal(*args)

    if _newclass:floatIsNormal = staticmethod(floatIsNormal)
    __swig_getmethods__["floatIsNormal"] = lambda x: floatIsNormal
    def secToMSec(*args):
        """secToMSec(double sec) -> double"""
        return _AriaPy.ArUtil_secToMSec(*args)

    if _newclass:secToMSec = staticmethod(secToMSec)
    __swig_getmethods__["secToMSec"] = lambda x: secToMSec
    def mSecToSec(*args):
        """mSecToSec(double msec) -> double"""
        return _AriaPy.ArUtil_mSecToSec(*args)

    if _newclass:mSecToSec = staticmethod(mSecToSec)
    __swig_getmethods__["mSecToSec"] = lambda x: mSecToSec
    def metersToFeet(*args):
        """metersToFeet(double m) -> double"""
        return _AriaPy.ArUtil_metersToFeet(*args)

    if _newclass:metersToFeet = staticmethod(metersToFeet)
    __swig_getmethods__["metersToFeet"] = lambda x: metersToFeet
    def feetToMeters(*args):
        """feetToMeters(double f) -> double"""
        return _AriaPy.ArUtil_feetToMeters(*args)

    if _newclass:feetToMeters = staticmethod(feetToMeters)
    __swig_getmethods__["feetToMeters"] = lambda x: feetToMeters
    def __init__(self): 
...
class ArMath(_object):
    ...
    if _newclass:addAngle = staticmethod(addAngle)
    __swig_getmethods__["addAngle"] = lambda x: addAngle
    def subAngle(*args):
        """subAngle(double ang1, double ang2) -> double"""
        return _AriaPy.ArMath_subAngle(*args)

    if _newclass:subAngle = staticmethod(subAngle)
    __swig_getmethods__["subAngle"] = lambda x: subAngle
    def fixAngle(*args):
        """fixAngle(double angle) -> double"""
        return _AriaPy.ArMath_fixAngle(*args)

    if _newclass:fixAngle = staticmethod(fixAngle)
    __swig_getmethods__["fixAngle"] = lambda x: fixAngle
    def degToRad(*args):
    ...
    if _newclass:angleBetween = staticmethod(angleBetween)
    __swig_getmethods__["angleBetween"] = lambda x: angleBetween
    def fabs(*args):
    ...
    if _newclass:roundInt = staticmethod(roundInt)
    __swig_getmethods__["roundInt"] = lambda x: roundInt
    def roundShort(*args):
        """roundShort(double val) -> short"""
        return _AriaPy.ArMath_roundShort(*args)

    if _newclass:roundShort = staticmethod(roundShort)
    __swig_getmethods__["roundShort"] = lambda x: roundShort
    def pointRotate(*args):
        """pointRotate(double th)"""
        return _AriaPy.ArMath_pointRotate(*args)

    if _newclass:pointRotate = staticmethod(pointRotate)
    __swig_getmethods__["pointRotate"] = lambda x: pointRotate
    def random():
        """random() -> long"""
    ...
    if _newclass:getRandMax = staticmethod(getRandMax)
    __swig_getmethods__["getRandMax"] = lambda x: getRandMax
    def randomInRange(*args):
        """randomInRange(long m, long n) -> long"""
        return _AriaPy.ArMath_randomInRange(*args)

    if _newclass:randomInRange = staticmethod(randomInRange)
    __swig_getmethods__["randomInRange"] = lambda x: randomInRange
    ...
    if _newclass:distanceBetween = staticmethod(distanceBetween)
    __swig_getmethods__["distanceBetween"] = lambda x: distanceBetween
    ...
    if _newclass:squaredDistanceBetween = staticmethod(squaredDistanceBetween)
    __swig_getmethods__["squaredDistanceBetween"] = lambda x: squaredDistanceBetween
    def log2(*args):
    ...
    if _newclass:isNan = staticmethod(isNan)
...
class ArTime(_object):
    ...
    if _newclass:usingMonotonicClock = staticmethod(usingMonotonicClock)
    __swig_getmethods__["usingMonotonicClock"] = lambda x: usingMonotonicClock
    def __eq__(self, *args):
...
class ArPoseWithTime(ArPose):
    ...
    __swig_setmethods__ = {}
    for _s in [ArPose]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArPoseWithTime, name, value)
    __swig_getmethods__ = {}
    for _s in [ArPose]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArRunningAverage(_object):
...
class ArRootMeanSquareCalculator(_object):
    """Proxy of C++ ArRootMeanSquareCalculator class"""
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArRootMeanSquareCalculator, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ArRootMeanSquareCalculator, name)
    __repr__ = _swig_repr
    def __init__(self): 
...
class ArLineSegmentCmpOp(_object):
...
class ArPriority(_object):
    ...
    if _newclass:getPriorityName = staticmethod(getPriorityName)
    __swig_getmethods__["getPriorityName"] = lambda x: getPriorityName
    def __init__(self): 
...
class ArStringInfoHolder(_object):
...
class ArStringInfoHolderFunctions(_object):
    ...
    if _newclass:intWrapper = staticmethod(intWrapper)
    __swig_getmethods__["intWrapper"] = lambda x: intWrapper
    ...
    if _newclass:doubleWrapper = staticmethod(doubleWrapper)
    __swig_getmethods__["doubleWrapper"] = lambda x: doubleWrapper
    ...
    if _newclass:boolWrapper = staticmethod(boolWrapper)
    __swig_getmethods__["boolWrapper"] = lambda x: boolWrapper
    ...
    if _newclass:stringWrapper = staticmethod(stringWrapper)
    __swig_getmethods__["stringWrapper"] = lambda x: stringWrapper
    ...
    if _newclass:unsignedLongWrapper = staticmethod(unsignedLongWrapper)
    __swig_getmethods__["unsignedLongWrapper"] = lambda x: unsignedLongWrapper
    def __init__(self): 
...
class ArCallbackList(_object):
    ...
    def addCallback(self, *args):
        ...
        """
        return _AriaPy.ArCallbackList_addCallback(self, *args)

    def remCallback(self, *args):
        """remCallback(self, ArFunctor functor)"""
        return _AriaPy.ArCallbackList_remCallback(self, *args)

    def setName(self, *args):
        """setName(self, char name)"""
        return _AriaPy.ArCallbackList_setName(self, *args)

    def setLogLevel(self, *args):
        """setLogLevel(self, LogLevel logLevel)"""
        return _AriaPy.ArCallbackList_setLogLevel(self, *args)

    def setSingleShot(self, *args):
        """setSingleShot(self, bool singleShot)"""
        return _AriaPy.ArCallbackList_setSingleShot(self, *args)
...
class md5_state_t(_object):
    ...
    if _newclass:count = _swig_property(_AriaPy.md5_state_t_count_get, _AriaPy.md5_state_t_count_set)
    __swig_setmethods__["abcd"] = _AriaPy.md5_state_t_abcd_set
    __swig_getmethods__["abcd"] = _AriaPy.md5_state_t_abcd_get
    if _newclass:abcd = _swig_property(_AriaPy.md5_state_t_abcd_get, _AriaPy.md5_state_t_abcd_set)
    __swig_setmethods__["buf"] = _AriaPy.md5_state_t_buf_set
    __swig_getmethods__["buf"] = _AriaPy.md5_state_t_buf_get
    if _newclass:buf = _swig_property(_AriaPy.md5_state_t_buf_get, _AriaPy.md5_state_t_buf_set)
    def __init__(self): 
...
class ArBasePacket(_object):
    ...
    def getBuf(self):
        """getBuf(self) -> char"""
        return _AriaPy.ArBasePacket_getBuf(self)
...
class ArRangeDeviceThreaded(ArRangeDevice):
    ...
    __swig_setmethods__ = {}
    for _s in [ArRangeDevice]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArRangeDeviceThreaded, name, value)
    __swig_getmethods__ = {}
    for _s in [ArRangeDevice]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArLaser(ArRangeDeviceThreaded):
    ...
    __swig_setmethods__ = {}
    for _s in [ArRangeDeviceThreaded]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArLaser, name, value)
    __swig_getmethods__ = {}
    for _s in [ArRangeDeviceThreaded]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArThread(_object):
    ...
    if _newclass:self = staticmethod(self)
    __swig_getmethods__["self"] = lambda x: self
    def osSelf():
        """osSelf() -> ThreadType"""
        return _AriaPy.ArThread_osSelf()

    if _newclass:osSelf = staticmethod(osSelf)
    __swig_getmethods__["osSelf"] = lambda x: osSelf
    def stopAll():
        """stopAll()"""
        return _AriaPy.ArThread_stopAll()

    if _newclass:stopAll = staticmethod(stopAll)
    __swig_getmethods__["stopAll"] = lambda x: stopAll
    def cancelAll():
        """cancelAll()"""
        return _AriaPy.ArThread_cancelAll()

    if _newclass:cancelAll = staticmethod(cancelAll)
    __swig_getmethods__["cancelAll"] = lambda x: cancelAll
    def joinAll():
        """joinAll()"""
        return _AriaPy.ArThread_joinAll()

    if _newclass:joinAll = staticmethod(joinAll)
    __swig_getmethods__["joinAll"] = lambda x: joinAll
    def yieldProcessor():
        """yieldProcessor()"""
        return _AriaPy.ArThread_yieldProcessor()

    if _newclass:yieldProcessor = staticmethod(yieldProcessor)
    __swig_getmethods__["yieldProcessor"] = lambda x: yieldProcessor
    def getLogLevel():
        """getLogLevel() -> LogLevel"""
        return _AriaPy.ArThread_getLogLevel()

    if _newclass:getLogLevel = staticmethod(getLogLevel)
    __swig_getmethods__["getLogLevel"] = lambda x: getLogLevel
    def setLogLevel(*args):
        """setLogLevel(LogLevel level)"""
        return _AriaPy.ArThread_setLogLevel(*args)

    if _newclass:setLogLevel = staticmethod(setLogLevel)
    __swig_getmethods__["setLogLevel"] = lambda x: setLogLevel
    ...
    if _newclass:getThisThreadName = staticmethod(getThisThreadName)
    __swig_getmethods__["getThisThreadName"] = lambda x: getThisThreadName
    def getThisThread():
        """getThisThread() -> ThreadType"""
        return _AriaPy.ArThread_getThisThread()

    if _newclass:getThisThread = staticmethod(getThisThread)
    __swig_getmethods__["getThisThread"] = lambda x: getThisThread
    def getThisOSThread():
        """getThisOSThread() -> ThreadType"""
        return _AriaPy.ArThread_getThisOSThread()

    if _newclass:getThisOSThread = staticmethod(getThisOSThread)
    __swig_getmethods__["getThisOSThread"] = lambda x: getThisOSThread
...
class ArRetFunctor_VoidP(ArFunctor):
    ...
    __swig_setmethods__ = {}
    for _s in [ArFunctor]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArRetFunctor_VoidP, name, value)
    __swig_getmethods__ = {}
    for _s in [ArFunctor]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArRetFunctor1_Double_ArPoseWithTime(ArRetFunctor_Double):
    ...
    __swig_setmethods__ = {}
    for _s in [ArRetFunctor_Double]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArRetFunctor1_Double_ArPoseWithTime, name, value)
    __swig_getmethods__ = {}
    for _s in [ArRetFunctor_Double]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArRetFunctor1_Bool_ArRobotPacketP(ArRetFunctor_Bool):
    ...
    __swig_setmethods__ = {}
    for _s in [ArRetFunctor_Bool]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArRetFunctor1_Bool_ArRobotPacketP, name, value)
    __swig_getmethods__ = {}
    for _s in [ArRetFunctor_Bool]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArRetFunctor1_VoidP_VoidP(ArRetFunctor_VoidP):
    ...
    __swig_setmethods__ = {}
    for _s in [ArRetFunctor_VoidP]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArRetFunctor1_VoidP_VoidP, name, value)
    __swig_getmethods__ = {}
    for _s in [ArRetFunctor_VoidP]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArAMPTUPacket(ArBasePacket):
    ...
    __swig_setmethods__ = {}
    for _s in [ArBasePacket]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArAMPTUPacket, name, value)
    __swig_getmethods__ = {}
    for _s in [ArBasePacket]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArAMPTU(ArPTZ):
    ...
    __swig_setmethods__ = {}
    for _s in [ArPTZ]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArAMPTU, name, value)
    __swig_getmethods__ = {}
    for _s in [ArPTZ]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    def pan(self, *args):
        ...
        return _AriaPy.ArAMPTU_pan(self, *args)

    def panRel(self, *args):
        """panRel(self, double deg) -> bool"""
        return _AriaPy.ArAMPTU_panRel(self, *args)

    def tilt(self, *args):
        """tilt(self, double deg) -> bool"""
        return _AriaPy.ArAMPTU_tilt(self, *args)

    def tiltRel(self, *args):
        """tiltRel(self, double deg) -> bool"""
        return _AriaPy.ArAMPTU_tiltRel(self, *args)

    def panTilt(self, *args):
        """panTilt(self, double panDeg, double tiltDeg) -> bool"""
        return _AriaPy.ArAMPTU_panTilt(self, *args)

    def panTiltRel(self, *args):
        """panTiltRel(self, double panDeg, double tiltDeg) -> bool"""
        return _AriaPy.ArAMPTU_panTiltRel(self, *args)
    ...
    def getMaxPosPan(self):
        """getMaxPosPan(self) -> double"""
        return _AriaPy.ArAMPTU_getMaxPosPan(self)

    def getMaxNegPan(self):
        """getMaxNegPan(self) -> double"""
        return _AriaPy.ArAMPTU_getMaxNegPan(self)

    def getMaxPosTilt(self):
        """getMaxPosTilt(self) -> double"""
        return _AriaPy.ArAMPTU_getMaxPosTilt(self)

    def getMaxNegTilt(self):
        """getMaxNegTilt(self) -> double"""
        return _AriaPy.ArAMPTU_getMaxNegTilt(self)
    ...
    def getPan(self):
        """getPan(self) -> double"""
        return _AriaPy.ArAMPTU_getPan(self)

    def getTilt(self):
        """getTilt(self) -> double"""
        return _AriaPy.ArAMPTU_getTilt(self)
...
class ArASyncTask(ArThread):
    ...
    __swig_setmethods__ = {}
    for _s in [ArThread]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArASyncTask, name, value)
    __swig_getmethods__ = {}
    for _s in [ArThread]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArAction(_object):
    ...
    if _newclass:setDefaultActivationState = staticmethod(setDefaultActivationState)
    __swig_getmethods__["setDefaultActivationState"] = lambda x: setDefaultActivationState
    def getDefaultActivationState():
        """getDefaultActivationState() -> bool"""
        return _AriaPy.ArAction_getDefaultActivationState()

    if _newclass:getDefaultActivationState = staticmethod(getDefaultActivationState)
    __swig_getmethods__["getDefaultActivationState"] = lambda x: getDefaultActivationState
...
class ArActionAvoidFront(ArAction):
    ...
    __swig_setmethods__ = {}
    for _s in [ArAction]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArActionAvoidFront, name, value)
    __swig_getmethods__ = {}
    for _s in [ArAction]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArActionDesiredChannel(_object):
...
class ArActionGroupInput(ArActionGroup):
    ...
    __swig_setmethods__ = {}
    for _s in [ArActionGroup]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArActionGroupInput, name, value)
    __swig_getmethods__ = {}
    for _s in [ArActionGroup]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArArgumentBuilder(_object):
...
class ArArgumentParser(_object):
    ...
    if _newclass:addDefaultArgumentFile = staticmethod(addDefaultArgumentFile)
    __swig_getmethods__["addDefaultArgumentFile"] = lambda x: addDefaultArgumentFile
    def addDefaultArgumentEnv(*args):
        """addDefaultArgumentEnv(char env)"""
        return _AriaPy.ArArgumentParser_addDefaultArgumentEnv(*args)

    if _newclass:addDefaultArgumentEnv = staticmethod(addDefaultArgumentEnv)
    __swig_getmethods__["addDefaultArgumentEnv"] = lambda x: addDefaultArgumentEnv
    def logDefaultArgumentLocations():
        """logDefaultArgumentLocations()"""
        return _AriaPy.ArArgumentParser_logDefaultArgumentLocations()

    if _newclass:logDefaultArgumentLocations = staticmethod(logDefaultArgumentLocations)
    __swig_getmethods__["logDefaultArgumentLocations"] = lambda x: logDefaultArgumentLocations
...
class ArCameraCollection(_object):
...
class ArCameraCollectionItem(_object):
...
class ArCameraParameterSource(ArCameraCollectionItem):
    ...
    __swig_setmethods__ = {}
    for _s in [ArCameraCollectionItem]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArCameraParameterSource, name, value)
    __swig_getmethods__ = {}
    for _s in [ArCameraCollectionItem]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArCameraCommands(_object):
    ...
    if _newclass:GET_CAMERA_DATA = _swig_property(_AriaPy.ArCameraCommands_GET_CAMERA_DATA_get, _AriaPy.ArCameraCommands_GET_CAMERA_DATA_set)
    ...
    if _newclass:GET_CAMERA_INFO = _swig_property(_AriaPy.ArCameraCommands_GET_CAMERA_INFO_get, _AriaPy.ArCameraCommands_GET_CAMERA_INFO_set)
    ...
    if _newclass:GET_PICTURE = _swig_property(_AriaPy.ArCameraCommands_GET_PICTURE_get, _AriaPy.ArCameraCommands_GET_PICTURE_set)
    ...
    if _newclass:GET_PICTURE_OPTIM = _swig_property(_AriaPy.ArCameraCommands_GET_PICTURE_OPTIM_get, _AriaPy.ArCameraCommands_GET_PICTURE_OPTIM_set)
    ...
    if _newclass:GET_SNAPSHOT = _swig_property(_AriaPy.ArCameraCommands_GET_SNAPSHOT_get, _AriaPy.ArCameraCommands_GET_SNAPSHOT_set)
    ...
    if _newclass:GET_DISPLAY = _swig_property(_AriaPy.ArCameraCommands_GET_DISPLAY_get, _AriaPy.ArCameraCommands_GET_DISPLAY_set)
    ...
    if _newclass:SET_CAMERA_ABS = _swig_property(_AriaPy.ArCameraCommands_SET_CAMERA_ABS_get, _AriaPy.ArCameraCommands_SET_CAMERA_ABS_set)
    ...
    if _newclass:SET_CAMERA_PCT = _swig_property(_AriaPy.ArCameraCommands_SET_CAMERA_PCT_get, _AriaPy.ArCameraCommands_SET_CAMERA_PCT_set)
    ...
    if _newclass:SET_CAMERA_REL = _swig_property(_AriaPy.ArCameraCommands_SET_CAMERA_REL_get, _AriaPy.ArCameraCommands_SET_CAMERA_REL_set)
    ...
    if _newclass:GET_CAMERA_MODE_LIST = _swig_property(_AriaPy.ArCameraCommands_GET_CAMERA_MODE_LIST_get, _AriaPy.ArCameraCommands_GET_CAMERA_MODE_LIST_set)
    ...
    if _newclass:CAMERA_MODE_UPDATED = _swig_property(_AriaPy.ArCameraCommands_CAMERA_MODE_UPDATED_get, _AriaPy.ArCameraCommands_CAMERA_MODE_UPDATED_set)
    ...
    if _newclass:SET_CAMERA_MODE = _swig_property(_AriaPy.ArCameraCommands_SET_CAMERA_MODE_get, _AriaPy.ArCameraCommands_SET_CAMERA_MODE_set)
    ...
    if _newclass:RESET_CAMERA = _swig_property(_AriaPy.ArCameraCommands_RESET_CAMERA_get, _AriaPy.ArCameraCommands_RESET_CAMERA_set)
    ...
    if _newclass:GET_CAMERA_DATA_INT = _swig_property(_AriaPy.ArCameraCommands_GET_CAMERA_DATA_INT_get, _AriaPy.ArCameraCommands_GET_CAMERA_DATA_INT_set)
    ...
    if _newclass:GET_CAMERA_INFO_INT = _swig_property(_AriaPy.ArCameraCommands_GET_CAMERA_INFO_INT_get, _AriaPy.ArCameraCommands_GET_CAMERA_INFO_INT_set)
    ...
    if _newclass:SET_CAMERA_ABS_INT = _swig_property(_AriaPy.ArCameraCommands_SET_CAMERA_ABS_INT_get, _AriaPy.ArCameraCommands_SET_CAMERA_ABS_INT_set)
    ...
    if _newclass:SET_CAMERA_REL_INT = _swig_property(_AriaPy.ArCameraCommands_SET_CAMERA_REL_INT_get, _AriaPy.ArCameraCommands_SET_CAMERA_REL_INT_set)
    ...
    if _newclass:SET_CAMERA_PCT_INT = _swig_property(_AriaPy.ArCameraCommands_SET_CAMERA_PCT_INT_get, _AriaPy.ArCameraCommands_SET_CAMERA_PCT_INT_set)
    ...
    if _newclass:GET_VIDEO = _swig_property(_AriaPy.ArCameraCommands_GET_VIDEO_get, _AriaPy.ArCameraCommands_GET_VIDEO_set)
    ...
    if _newclass:GET_SNAPSHOT_PLAIN = _swig_property(_AriaPy.ArCameraCommands_GET_SNAPSHOT_PLAIN_get, _AriaPy.ArCameraCommands_GET_SNAPSHOT_PLAIN_set)
    def __init__(self): 
...
class ArConfigArg(_object):
    ...
    def getInt(self):
        """getInt(self) -> int"""
        return _AriaPy.ArConfigArg_getInt(self)

    def getDouble(self):
        """getDouble(self) -> double"""
        return _AriaPy.ArConfigArg_getDouble(self)

    def getBool(self):
        """getBool(self) -> bool"""
        return _AriaPy.ArConfigArg_getBool(self)

    def getString(self):
        """getString(self) -> char"""
        return _AriaPy.ArConfigArg_getString(self)

    def getArgsWithFunctor(self):
        """getArgsWithFunctor(self) -> ArArgumentBuilderPtrList"""
        return _AriaPy.ArConfigArg_getArgsWithFunctor(self)
    ...
    def log(self, verbose = False):
        ...
        log(self)
        """
        return _AriaPy.ArConfigArg_log(self, verbose)

    def getMinInt(self):
        """getMinInt(self) -> int"""
        return _AriaPy.ArConfigArg_getMinInt(self)

    def getMaxInt(self):
        """getMaxInt(self) -> int"""
        return _AriaPy.ArConfigArg_getMaxInt(self)

    def getMinDouble(self):
        """getMinDouble(self) -> double"""
        return _AriaPy.ArConfigArg_getMinDouble(self)

    def getMaxDouble(self):
        """getMaxDouble(self) -> double"""
        return _AriaPy.ArConfigArg_getMaxDouble(self)
...
class ArDPPTU(ArPTZ):
    ...
    def panTilt(self, *args):
        ...
        return _AriaPy.ArDPPTU_panTilt(self, *args)

    def pan(self, *args):
        """pan(self, double deg) -> bool"""
        return _AriaPy.ArDPPTU_pan(self, *args)

    def panRel(self, *args):
        """panRel(self, double deg) -> bool"""
        return _AriaPy.ArDPPTU_panRel(self, *args)

    def tilt(self, *args):
        """tilt(self, double deg) -> bool"""
        return _AriaPy.ArDPPTU_tilt(self, *args)

    def tiltRel(self, *args):
        """tiltRel(self, double deg) -> bool"""
        return _AriaPy.ArDPPTU_tiltRel(self, *args)

    def panTiltRel(self, *args):
        """panTiltRel(self, double pdeg, double tdeg) -> bool"""
        return _AriaPy.ArDPPTU_panTiltRel(self, *args)
    ...
    def getMaxPosPan(self):
        """getMaxPosPan(self) -> double"""
        return _AriaPy.ArDPPTU_getMaxPosPan(self)

    def getMaxNegPan(self):
        """getMaxNegPan(self) -> double"""
        return _AriaPy.ArDPPTU_getMaxNegPan(self)

    def getMaxPosTilt(self):
        """getMaxPosTilt(self) -> double"""
        return _AriaPy.ArDPPTU_getMaxPosTilt(self)

    def getMaxNegTilt(self):
        """getMaxNegTilt(self) -> double"""
        return _AriaPy.ArDPPTU_getMaxNegTilt(self)
    ...
    def getPan(self):
        """getPan(self) -> double"""
        return _AriaPy.ArDPPTU_getPan(self)

    def getTilt(self):
        """getTilt(self) -> double"""
        return _AriaPy.ArDPPTU_getTilt(self)
...
class ArDeviceConnection(_object):
...
class ArFileParser(_object):
    ...
    def __init__(self, baseDirectory = "./"): 
        ...
        """
        this = _AriaPy.new_ArFileParser(baseDirectory)
        try: self.this.append(this)
        except: self.this = this
...
class ArFunctorASyncTask(ArASyncTask):
    ...
    __swig_setmethods__ = {}
    for _s in [ArASyncTask]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArFunctorASyncTask, name, value)
    __swig_getmethods__ = {}
    for _s in [ArASyncTask]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArGPS(_object):
    ...
    def blockingConnect(self, connectTimeout = 10000):
        """
    ...
    if _newclass:ReadFlags = _swig_property(_AriaPy.ArGPS_ReadFlags_get, _AriaPy.ArGPS_ReadFlags_set)
    ...
    if _newclass:getFixTypeName = staticmethod(getFixTypeName)
    __swig_getmethods__["getFixTypeName"] = lambda x: getFixTypeName
...
class ArWGS84(_object):
    ...
    if _newclass:getE = staticmethod(getE)
    __swig_getmethods__["getE"] = lambda x: getE
    def getA():
        """getA() -> double"""
        return _AriaPy.ArWGS84_getA()

    if _newclass:getA = staticmethod(getA)
    __swig_getmethods__["getA"] = lambda x: getA
    def getB():
        """getB() -> double"""
        return _AriaPy.ArWGS84_getB()

    if _newclass:getB = staticmethod(getB)
    __swig_getmethods__["getB"] = lambda x: getB
    def getEP():
        """getEP() -> double"""
        return _AriaPy.ArWGS84_getEP()

    if _newclass:getEP = staticmethod(getEP)
    __swig_getmethods__["getEP"] = lambda x: getEP
    def get1byf():
        """get1byf() -> double"""
        return _AriaPy.ArWGS84_get1byf()

    if _newclass:get1byf = staticmethod(get1byf)
    __swig_getmethods__["get1byf"] = lambda x: get1byf
    def getOmega():
        """getOmega() -> double"""
        return _AriaPy.ArWGS84_getOmega()

    if _newclass:getOmega = staticmethod(getOmega)
    __swig_getmethods__["getOmega"] = lambda x: getOmega
    def getGM():
        """getGM() -> double"""
        return _AriaPy.ArWGS84_getGM()

    if _newclass:getGM = staticmethod(getGM)
    __swig_getmethods__["getGM"] = lambda x: getGM
...
class ArECEFCoords(Ar3DPoint):
    ...
    __swig_setmethods__ = {}
    for _s in [Ar3DPoint]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArECEFCoords, name, value)
    __swig_getmethods__ = {}
    for _s in [Ar3DPoint]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArMapGPSCoords(ArENUCoords):
    ...
    __swig_setmethods__ = {}
    for _s in [ArENUCoords]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArMapGPSCoords, name, value)
    __swig_getmethods__ = {}
    for _s in [ArENUCoords]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    if _newclass:myOriginECEF = _swig_property(_AriaPy.ArMapGPSCoords_myOriginECEF_get, _AriaPy.ArMapGPSCoords_myOriginECEF_set)
    ...
    if _newclass:myOriginLLA = _swig_property(_AriaPy.ArMapGPSCoords_myOriginLLA_get, _AriaPy.ArMapGPSCoords_myOriginLLA_set)
    ...
    if _newclass:myOriginSet = _swig_property(_AriaPy.ArMapGPSCoords_myOriginSet_get, _AriaPy.ArMapGPSCoords_myOriginSet_set)
...
class ArGripperCommands(_object):
...
class ArLMS2xx(ArLaser):
    ...
    __swig_setmethods__ = {}
    for _s in [ArLaser]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArLMS2xx, name, value)
    __swig_getmethods__ = {}
    for _s in [ArLaser]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    def __init__(self, *args): 
        ...
        """
        this = _AriaPy.new_ArLMS2xx(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def blockingConnect(self):
        """blockingConnect(self) -> bool"""
        return _AriaPy.ArLMS2xx_blockingConnect(self)

    def asyncConnect(self):
        """asyncConnect(self) -> bool"""
        return _AriaPy.ArLMS2xx_asyncConnect(self)

    def disconnect(self):
        """disconnect(self) -> bool"""
        return _AriaPy.ArLMS2xx_disconnect(self)

    def isConnected(self):
        """isConnected(self) -> bool"""
        return _AriaPy.ArLMS2xx_isConnected(self)

    def isTryingToConnect(self):
        """isTryingToConnect(self) -> bool"""
        return _AriaPy.ArLMS2xx_isTryingToConnect(self)

    def setDeviceConnection(self, *args):
        """setDeviceConnection(self, ArDeviceConnection conn)"""
        return _AriaPy.ArLMS2xx_setDeviceConnection(self, *args)

    def runThread(self, *args):
        """runThread(self, void arg) -> void"""
        return _AriaPy.ArLMS2xx_runThread(self, *args)

    def setRobot(self, *args):
        """setRobot(self, ArRobot robot)"""
        return _AriaPy.ArLMS2xx_setRobot(self, *args)
...
class ArLMS2xxPacket(ArBasePacket):
    ...
    __repr__ = _swig_repr
    def __init__(self, sendingAddress = 0): 
        """
        __init__(self, unsigned char sendingAddress = 0) -> ArLMS2xxPacket
        __init__(self) -> ArLMS2xxPacket
        """
        this = _AriaPy.new_ArLMS2xxPacket(sendingAddress)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _AriaPy.delete_ArLMS2xxPacket
    __del__ = lambda self : None;
    def setSendingAddress(self, *args):
        """setSendingAddress(self, unsigned char address)"""
        return _AriaPy.ArLMS2xxPacket_setSendingAddress(self, *args)

    def getSendingAddress(self):
        """getSendingAddress(self) -> unsigned char"""
        return _AriaPy.ArLMS2xxPacket_getSendingAddress(self)

    def getReceivedAddress(self):
        """getReceivedAddress(self) -> unsigned char"""
        return _AriaPy.ArLMS2xxPacket_getReceivedAddress(self)

    def verifyCRC(self):
        """verifyCRC(self) -> bool"""
        return _AriaPy.ArLMS2xxPacket_verifyCRC(self)

    def getID(self):
        """getID(self) -> UByte"""
        return _AriaPy.ArLMS2xxPacket_getID(self)

    def calcCRC(self):
        """calcCRC(self) -> Byte2"""
        return _AriaPy.ArLMS2xxPacket_calcCRC(self)

    def finalizePacket(self):
        """finalizePacket(self)"""
        return _AriaPy.ArLMS2xxPacket_finalizePacket(self)

    def resetRead(self):
        """resetRead(self)"""
        return _AriaPy.ArLMS2xxPacket_resetRead(self)

    def getTimeReceived(self):
        """getTimeReceived(self) -> ArTime"""
        return _AriaPy.ArLMS2xxPacket_getTimeReceived(self)

    def setTimeReceived(self, *args):
        """setTimeReceived(self, ArTime timeReceived)"""
        return _AriaPy.ArLMS2xxPacket_setTimeReceived(self, *args)

    def duplicatePacket(self, *args):
        """duplicatePacket(self, ArLMS2xxPacket packet)"""
        return _AriaPy.ArLMS2xxPacket_duplicatePacket(self, *args)

ArLMS2xxPacket_swigregister = _AriaPy.ArLMS2xxPacket_swigregister
ArLMS2xxPacket_swigregister(ArLMS2xxPacket)

class ArLMS2xxPacketReceiver(_object):
    ...
    def __init__(self, *args): 
        ...
        """
        this = _AriaPy.new_ArLMS2xxPacketReceiver(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def receivePacket(self, msWait = 0):
        ...
        """
        return _AriaPy.ArLMS2xxPacketReceiver_receivePacket(self, msWait)

    def setDeviceConnection(self, *args):
        """setDeviceConnection(self, ArDeviceConnection deviceConnection)"""
        return _AriaPy.ArLMS2xxPacketReceiver_setDeviceConnection(self, *args)

    def getDeviceConnection(self):
        """getDeviceConnection(self) -> ArDeviceConnection"""
        return _AriaPy.ArLMS2xxPacketReceiver_getDeviceConnection(self)

    def isAllocatingPackets(self):
        """isAllocatingPackets(self) -> bool"""
        return _AriaPy.ArLMS2xxPacketReceiver_isAllocatingPackets(self)
...
class ArLaserConnector(_object):
...
class ArLineFinderSegment(ArLineSegment):
    ...
    __swig_setmethods__ = {}
    for _s in [ArLineSegment]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArLineFinderSegment, name, value)
    __swig_getmethods__ = {}
    for _s in [ArLineSegment]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArLog(_object):
    ...
    if _newclass:logErrorFromOS = staticmethod(logErrorFromOS)
    __swig_getmethods__["logErrorFromOS"] = lambda x: logErrorFromOS
    def logErrorFromOSPlain(*args):
        """logErrorFromOSPlain(LogLevel level, char str)"""
        return _AriaPy.ArLog_logErrorFromOSPlain(*args)

    if _newclass:logErrorFromOSPlain = staticmethod(logErrorFromOSPlain)
    __swig_getmethods__["logErrorFromOSPlain"] = lambda x: logErrorFromOSPlain
    ...
    if _newclass:colbertPrint = _swig_property(_AriaPy.ArLog_colbertPrint_get, _AriaPy.ArLog_colbertPrint_set)
    def addToConfig(*args):
        """addToConfig(ArConfig config)"""
        return _AriaPy.ArLog_addToConfig(*args)

    if _newclass:addToConfig = staticmethod(addToConfig)
    __swig_getmethods__["addToConfig"] = lambda x: addToConfig
    def aramInit(*args):
        """
    ...
    if _newclass:aramInit = staticmethod(aramInit)
    __swig_getmethods__["aramInit"] = lambda x: aramInit
    def setFunctor(*args):
        """setFunctor(ArFunctor1_CString functor)"""
        return _AriaPy.ArLog_setFunctor(*args)

    if _newclass:setFunctor = staticmethod(setFunctor)
    __swig_getmethods__["setFunctor"] = lambda x: setFunctor
    def __init__(self): 
        """__init__(self) -> ArLog"""
...
class ArLogFileConnection(ArDeviceConnection):
    ...
    __swig_setmethods__ = {}
    for _s in [ArDeviceConnection]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArLogFileConnection, name, value)
    __swig_getmethods__ = {}
    for _s in [ArDeviceConnection]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    if _newclass:myPose = _swig_property(_AriaPy.ArLogFileConnection_myPose_get, _AriaPy.ArLogFileConnection_myPose_set)
    ...
    if _newclass:havePose = _swig_property(_AriaPy.ArLogFileConnection_havePose_get, _AriaPy.ArLogFileConnection_havePose_set)
    ...
    if _newclass:myName = _swig_property(_AriaPy.ArLogFileConnection_myName_get, _AriaPy.ArLogFileConnection_myName_set)
    ...
    if _newclass:myType = _swig_property(_AriaPy.ArLogFileConnection_myType_get, _AriaPy.ArLogFileConnection_myType_set)
    ...
    if _newclass:mySubtype = _swig_property(_AriaPy.ArLogFileConnection_mySubtype_get, _AriaPy.ArLogFileConnection_mySubtype_set)
...
class ArMD5Calculator(_object):
    ...
    if _newclass:toDisplay = staticmethod(toDisplay)
    __swig_getmethods__["toDisplay"] = lambda x: toDisplay
    ...
    if _newclass:calculateChecksum = staticmethod(calculateChecksum)
    __swig_getmethods__["calculateChecksum"] = lambda x: calculateChecksum
...
class ArMapScanInterface(_object):
    ...
    if _newclass:isDefaultScanType = staticmethod(isDefaultScanType)
    __swig_getmethods__["isDefaultScanType"] = lambda x: isDefaultScanType
    def isSummaryScanType(*args):
        """isSummaryScanType(char scanType) -> bool"""
        return _AriaPy.ArMapScanInterface_isSummaryScanType(*args)

    if _newclass:isSummaryScanType = staticmethod(isSummaryScanType)
    __swig_getmethods__["isSummaryScanType"] = lambda x: isSummaryScanType
...
class ArMapObjectsInterface(_object):
...
class ArMapInfoInterface(_object):
    ...
    if _newclass:MAP_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_MAP_INFO_NAME_get, _AriaPy.ArMapInfoInterface_MAP_INFO_NAME_set)
    ...
    if _newclass:META_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_META_INFO_NAME_get, _AriaPy.ArMapInfoInterface_META_INFO_NAME_set)
    ...
    if _newclass:TASK_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_TASK_INFO_NAME_get, _AriaPy.ArMapInfoInterface_TASK_INFO_NAME_set)
    ...
    if _newclass:ROUTE_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_ROUTE_INFO_NAME_get, _AriaPy.ArMapInfoInterface_ROUTE_INFO_NAME_set)
    ...
    if _newclass:SCHED_TASK_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_SCHED_TASK_INFO_NAME_get, _AriaPy.ArMapInfoInterface_SCHED_TASK_INFO_NAME_set)
    ...
    if _newclass:SCHED_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_SCHED_INFO_NAME_get, _AriaPy.ArMapInfoInterface_SCHED_INFO_NAME_set)
    ...
    if _newclass:CAIRN_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_CAIRN_INFO_NAME_get, _AriaPy.ArMapInfoInterface_CAIRN_INFO_NAME_set)
    ...
    if _newclass:CUSTOM_INFO_NAME = _swig_property(_AriaPy.ArMapInfoInterface_CUSTOM_INFO_NAME_get, _AriaPy.ArMapInfoInterface_CUSTOM_INFO_NAME_set)
...
class ArMapSupplementInterface(_object):
...
class ArMapInterface(ArMapInfoInterface,ArMapObjectsInterface,ArMapScanInterface,ArMapSupplementInterface):
    ...
    __swig_setmethods__ = {}
    for _s in [ArMapInfoInterface,ArMapObjectsInterface,ArMapScanInterface,ArMapSupplementInterface]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArMapInterface, name, value)
    __swig_getmethods__ = {}
    for _s in [ArMapInfoInterface,ArMapObjectsInterface,ArMapScanInterface,ArMapSupplementInterface]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    if _newclass:MAP_CATEGORY_2D = _swig_property(_AriaPy.ArMapInterface_MAP_CATEGORY_2D_get, _AriaPy.ArMapInterface_MAP_CATEGORY_2D_set)
    ...
    if _newclass:MAP_CATEGORY_2D_MULTI_SOURCES = _swig_property(_AriaPy.ArMapInterface_MAP_CATEGORY_2D_MULTI_SOURCES_get, _AriaPy.ArMapInterface_MAP_CATEGORY_2D_MULTI_SOURCES_set)
    ...
    if _newclass:MAP_CATEGORY_2D_EXTENDED = _swig_property(_AriaPy.ArMapInterface_MAP_CATEGORY_2D_EXTENDED_get, _AriaPy.ArMapInterface_MAP_CATEGORY_2D_EXTENDED_set)
    ...
    def addMapChangedCBPos(self, *args):
        """addMapChangedCBPos(self, ArFunctor functor, Pos position = LAST)"""
    ...
    def addPreMapChangedCBPos(self, *args):
        """addPreMapChangedCBPos(self, ArFunctor functor, Pos position = LAST)"""
...
class ArMap(ArMapInterface):
    ...
    __swig_setmethods__ = {}
    for _s in [ArMapInterface]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArMap, name, value)
    __swig_getmethods__ = {}
    for _s in [ArMapInterface]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    def addMapChangedCBPos(self, *args):
        """addMapChangedCBPos(self, ArFunctor functor, Pos position = LAST)"""
        return _AriaPy.ArMap_addMapChangedCBPos(self, *args)
    ...
    def addPreMapChangedCBPos(self, *args):
        """addPreMapChangedCBPos(self, ArFunctor functor, Pos position = LAST)"""
        return _AriaPy.ArMap_addPreMapChangedCBPos(self, *args)
...
class ArMapScan(ArMapScanInterface):
    ...
    __swig_setmethods__ = {}
    for _s in [ArMapScanInterface]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArMapScan, name, value)
    __swig_getmethods__ = {}
    for _s in [ArMapScanInterface]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArMapObjects(ArMapObjectsInterface):
    ...
    __swig_setmethods__ = {}
    for _s in [ArMapObjectsInterface]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArMapObjects, name, value)
    __swig_getmethods__ = {}
    for _s in [ArMapObjectsInterface]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArMapInfo(ArMapInfoInterface):
    ...
    __swig_setmethods__ = {}
    for _s in [ArMapInfoInterface]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArMapInfo, name, value)
    __swig_getmethods__ = {}
    for _s in [ArMapInfoInterface]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArMapSupplement(ArMapSupplementInterface):
    ...
    __swig_setmethods__ = {}
    for _s in [ArMapSupplementInterface]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArMapSupplement, name, value)
    __swig_getmethods__ = {}
    for _s in [ArMapSupplementInterface]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArDataTagCaseCmpOp(_object):
...
class ArMapSimple(ArMapInterface):
    ...
    def addMapChangedCBPos(self, *args):
        """addMapChangedCBPos(self, ArFunctor functor, Pos position = LAST)"""
        return _AriaPy.ArMapSimple_addMapChangedCBPos(self, *args)
    ...
    def addPreMapChangedCBPos(self, *args):
        """addPreMapChangedCBPos(self, ArFunctor functor, Pos position = LAST)"""
        return _AriaPy.ArMapSimple_addPreMapChangedCBPos(self, *args)
    ...
    if _newclass:findMapObjectParamInfo = staticmethod(findMapObjectParamInfo)
    __swig_getmethods__["findMapObjectParamInfo"] = lambda x: findMapObjectParamInfo
...
class ArMapObject(_object):
    ...
    if _newclass:createMapObject = staticmethod(createMapObject)
    __swig_getmethods__["createMapObject"] = lambda x: createMapObject
    def __init__(self, *args): 
        """
...
class ArMapId(_object):
    ...
    if _newclass:toPacket = staticmethod(toPacket)
    __swig_getmethods__["toPacket"] = lambda x: toPacket
    def fromPacket(*args):
        """fromPacket(ArBasePacket packetIn, ArMapId mapIdOut) -> bool"""
        return _AriaPy.ArMapId_fromPacket(*args)

    if _newclass:fromPacket = staticmethod(fromPacket)
    __swig_getmethods__["fromPacket"] = lambda x: fromPacket
    def __init__(self, *args): 
        """
...
class ArMode(_object):
    ...
    if _newclass:baseHelp = staticmethod(baseHelp)
    __swig_getmethods__["baseHelp"] = lambda x: baseHelp
    def getKey(self):
        """getKey(self) -> char"""
...
class ArModeTeleop(ArMode):
    ...
    __swig_setmethods__ = {}
    for _s in [ArMode]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArModeTeleop, name, value)
    __swig_getmethods__ = {}
    for _s in [ArMode]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArModuleLoader(_object):
    ...
    if _newclass:reload = staticmethod(reload)
    __swig_getmethods__["reload"] = lambda x: reload
    def close(*args):
        """
    ...
    if _newclass:closeAll = staticmethod(closeAll)
    __swig_getmethods__["closeAll"] = lambda x: closeAll
    def __init__(self): 
...
class ArMutex(_object):
    ...
    if _newclass:setLockWarningTime = staticmethod(setLockWarningTime)
    __swig_getmethods__["setLockWarningTime"] = lambda x: setLockWarningTime
    def getLockWarningTime():
        """getLockWarningTime() -> double"""
        return _AriaPy.ArMutex_getLockWarningTime()

    if _newclass:getLockWarningTime = staticmethod(getLockWarningTime)
    __swig_getmethods__["getLockWarningTime"] = lambda x: getLockWarningTime
    ...
    if _newclass:setUnlockWarningTime = staticmethod(setUnlockWarningTime)
    __swig_getmethods__["setUnlockWarningTime"] = lambda x: setUnlockWarningTime
    def getUnlockWarningTime():
        """getUnlockWarningTime() -> double"""
        return _AriaPy.ArMutex_getUnlockWarningTime()

    if _newclass:getUnlockWarningTime = staticmethod(getUnlockWarningTime)
    __swig_getmethods__["getUnlockWarningTime"] = lambda x: getUnlockWarningTime
...
class ArNMEAParser(_object):
    ...
    if _newclass:ParseFlags = _swig_property(_AriaPy.ArNMEAParser_ParseFlags_get, _AriaPy.ArNMEAParser_ParseFlags_set)
    def setIgnoreChecksum(self, *args):
        """setIgnoreChecksum(self, bool ignore)"""
...
class ArNMEAParser_Message(_object):
    ...
    if _newclass:message = _swig_property(_AriaPy.ArNMEAParser_Message_message_get, _AriaPy.ArNMEAParser_Message_message_set)
    ...
    if _newclass:timeParseStarted = _swig_property(_AriaPy.ArNMEAParser_Message_timeParseStarted_get, _AriaPy.ArNMEAParser_Message_timeParseStarted_set)
    def __init__(self): 
...
class ArNetServer(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, addAriaExitCB = True): 
        """
        __init__(self, bool addAriaExitCB = True) -> ArNetServer
        __init__(self) -> ArNetServer
        """
        this = _AriaPy.new_ArNetServer(addAriaExitCB)
        try: self.this.append(this)
        except: self.this = this
...
class ArNovatelGPS(ArGPS):
    ...
    __swig_setmethods__ = {}
    for _s in [ArGPS]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArNovatelGPS, name, value)
    __swig_getmethods__ = {}
    for _s in [ArGPS]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArNovatelSPAN(ArNovatelGPS):
    ...
    __swig_setmethods__ = {}
    for _s in [ArNovatelGPS]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArNovatelSPAN, name, value)
    __swig_getmethods__ = {}
    for _s in [ArNovatelGPS]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ArNovatelSPAN, name)
    __repr__ = _swig_repr
    __swig_setmethods__["GPSLatitude"] = _AriaPy.ArNovatelSPAN_GPSLatitude_set
    __swig_getmethods__["GPSLatitude"] = _AriaPy.ArNovatelSPAN_GPSLatitude_get
    if _newclass:GPSLatitude = _swig_property(_AriaPy.ArNovatelSPAN_GPSLatitude_get, _AriaPy.ArNovatelSPAN_GPSLatitude_set)
    __swig_setmethods__["GPSLongitude"] = _AriaPy.ArNovatelSPAN_GPSLongitude_set
    __swig_getmethods__["GPSLongitude"] = _AriaPy.ArNovatelSPAN_GPSLongitude_get
    if _newclass:GPSLongitude = _swig_property(_AriaPy.ArNovatelSPAN_GPSLongitude_get, _AriaPy.ArNovatelSPAN_GPSLongitude_set)
    __swig_setmethods__["haveGPSPosition"] = _AriaPy.ArNovatelSPAN_haveGPSPosition_set
    __swig_getmethods__["haveGPSPosition"] = _AriaPy.ArNovatelSPAN_haveGPSPosition_get
    if _newclass:haveGPSPosition = _swig_property(_AriaPy.ArNovatelSPAN_haveGPSPosition_get, _AriaPy.ArNovatelSPAN_haveGPSPosition_set)
    __swig_setmethods__["GPSValidFlag"] = _AriaPy.ArNovatelSPAN_GPSValidFlag_set
    __swig_getmethods__["GPSValidFlag"] = _AriaPy.ArNovatelSPAN_GPSValidFlag_get
    if _newclass:GPSValidFlag = _swig_property(_AriaPy.ArNovatelSPAN_GPSValidFlag_get, _AriaPy.ArNovatelSPAN_GPSValidFlag_set)
    __swig_setmethods__["timeGotGPSPosition"] = _AriaPy.ArNovatelSPAN_timeGotGPSPosition_set
    __swig_getmethods__["timeGotGPSPosition"] = _AriaPy.ArNovatelSPAN_timeGotGPSPosition_get
    if _newclass:timeGotGPSPosition = _swig_property(_AriaPy.ArNovatelSPAN_timeGotGPSPosition_get, _AriaPy.ArNovatelSPAN_timeGotGPSPosition_set)
    __swig_setmethods__["GPSTimestamp"] = _AriaPy.ArNovatelSPAN_GPSTimestamp_set
    __swig_getmethods__["GPSTimestamp"] = _AriaPy.ArNovatelSPAN_GPSTimestamp_get
    if _newclass:GPSTimestamp = _swig_property(_AriaPy.ArNovatelSPAN_GPSTimestamp_get, _AriaPy.ArNovatelSPAN_GPSTimestamp_set)
    def __init__(self): 
...
class P2ArmJoint(_object):
    ...
    if _newclass:myPos = _swig_property(_AriaPy.P2ArmJoint_myPos_get, _AriaPy.P2ArmJoint_myPos_set)
    __swig_setmethods__["myVel"] = _AriaPy.P2ArmJoint_myVel_set
    __swig_getmethods__["myVel"] = _AriaPy.P2ArmJoint_myVel_get
    if _newclass:myVel = _swig_property(_AriaPy.P2ArmJoint_myVel_get, _AriaPy.P2ArmJoint_myVel_set)
    __swig_setmethods__["myHome"] = _AriaPy.P2ArmJoint_myHome_set
    __swig_getmethods__["myHome"] = _AriaPy.P2ArmJoint_myHome_get
    if _newclass:myHome = _swig_property(_AriaPy.P2ArmJoint_myHome_get, _AriaPy.P2ArmJoint_myHome_set)
    __swig_setmethods__["myMin"] = _AriaPy.P2ArmJoint_myMin_set
    __swig_getmethods__["myMin"] = _AriaPy.P2ArmJoint_myMin_get
    if _newclass:myMin = _swig_property(_AriaPy.P2ArmJoint_myMin_get, _AriaPy.P2ArmJoint_myMin_set)
    __swig_setmethods__["myCenter"] = _AriaPy.P2ArmJoint_myCenter_set
    __swig_getmethods__["myCenter"] = _AriaPy.P2ArmJoint_myCenter_get
    if _newclass:myCenter = _swig_property(_AriaPy.P2ArmJoint_myCenter_get, _AriaPy.P2ArmJoint_myCenter_set)
    __swig_setmethods__["myMax"] = _AriaPy.P2ArmJoint_myMax_set
    __swig_getmethods__["myMax"] = _AriaPy.P2ArmJoint_myMax_get
    if _newclass:myMax = _swig_property(_AriaPy.P2ArmJoint_myMax_get, _AriaPy.P2ArmJoint_myMax_set)
    ...
    if _newclass:myTicksPer90 = _swig_property(_AriaPy.P2ArmJoint_myTicksPer90_get, _AriaPy.P2ArmJoint_myTicksPer90_set)
P2ArmJoint_swigregister = _AriaPy.P2ArmJoint_swigregister
P2ArmJoint_swigregister(P2ArmJoint)

class ArP2Arm(_object):
    ...
    if _newclass:NumJoints = _swig_property(_AriaPy.ArP2Arm_NumJoints_get, _AriaPy.ArP2Arm_NumJoints_set)
    def __init__(self): 
...
class ArPriorityResolver(ArResolver):
    ...
    __swig_setmethods__ = {}
    for _s in [ArResolver]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArPriorityResolver, name, value)
    __swig_getmethods__ = {}
    for _s in [ArResolver]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArRangeBuffer(_object):
    ...
    if _newclass:getClosestPolarInList = staticmethod(getClosestPolarInList)
    __swig_getmethods__["getClosestPolarInList"] = lambda x: getClosestPolarInList
    ...
    if _newclass:getClosestBoxInList = staticmethod(getClosestBoxInList)
    __swig_getmethods__["getClosestBoxInList"] = lambda x: getClosestBoxInList
...
class ArRatioInputJoydrive(_object):
...
class ArRatioInputKeydrive(_object):
...
class ArRatioInputRobotJoydrive(_object):
...
class ArRobot(_object):
    ...
    if _newclass:myMotorPacketCB = _swig_property(_AriaPy.ArRobot_myMotorPacketCB_get, _AriaPy.ArRobot_myMotorPacketCB_set)
    ...
    if _newclass:myEncoderPacketCB = _swig_property(_AriaPy.ArRobot_myEncoderPacketCB_get, _AriaPy.ArRobot_myEncoderPacketCB_set)
    ...
    if _newclass:myIOPacketCB = _swig_property(_AriaPy.ArRobot_myIOPacketCB_get, _AriaPy.ArRobot_myIOPacketCB_set)
    ...
    if _newclass:myPacketHandlerCB = _swig_property(_AriaPy.ArRobot_myPacketHandlerCB_get, _AriaPy.ArRobot_myPacketHandlerCB_set)
    ...
    if _newclass:myActionHandlerCB = _swig_property(_AriaPy.ArRobot_myActionHandlerCB_get, _AriaPy.ArRobot_myActionHandlerCB_set)
    ...
    if _newclass:myStateReflectorCB = _swig_property(_AriaPy.ArRobot_myStateReflectorCB_get, _AriaPy.ArRobot_myStateReflectorCB_set)
    ...
    if _newclass:myRobotLockerCB = _swig_property(_AriaPy.ArRobot_myRobotLockerCB_get, _AriaPy.ArRobot_myRobotLockerCB_set)
    ...
    if _newclass:myRobotUnlockerCB = _swig_property(_AriaPy.ArRobot_myRobotUnlockerCB_get, _AriaPy.ArRobot_myRobotUnlockerCB_set)
    ...
    if _newclass:myKeyHandlerExitCB = _swig_property(_AriaPy.ArRobot_myKeyHandlerExitCB_get, _AriaPy.ArRobot_myKeyHandlerExitCB_set)
    ...
    if _newclass:myKeyHandlerCB = _swig_property(_AriaPy.ArRobot_myKeyHandlerCB_get, _AriaPy.ArRobot_myKeyHandlerCB_set)
    ...
    def dropConnection(self):
        """dropConnection(self)"""
        return _AriaPy.ArRobot_dropConnection(self)
    ...
    def madeConnection(self):
        ...
        return _AriaPy.ArRobot_madeConnection(self)
    ...
    if _newclass:myGetCycleWarningTimeCB = _swig_property(_AriaPy.ArRobot_myGetCycleWarningTimeCB_get, _AriaPy.ArRobot_myGetCycleWarningTimeCB_set)
    ...
    if _newclass:myGetNoTimeWarningThisCycleCB = _swig_property(_AriaPy.ArRobot_myGetNoTimeWarningThisCycleCB_get, _AriaPy.ArRobot_myGetNoTimeWarningThisCycleCB_set)
...
class ArRobotConfigPacketReader(_object):
...
class ArRobotConnector(_object):
...
class ArRobotJoyHandler(_object):
...
class ArRobotPacketReceiver(_object):
...
class ArRobotPacketSender(_object):
...
class ArRobotParams(ArConfig):
    ...
    __swig_setmethods__ = {}
    for _s in [ArConfig]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArRobotParams, name, value)
    __swig_getmethods__ = {}
    for _s in [ArConfig]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArRVisionPTZ(ArPTZ):
    ...
    def pan(self, *args):
        """pan(self, double degrees) -> bool"""
        return _AriaPy.ArRVisionPTZ_pan(self, *args)

    def panRel(self, *args):
        """panRel(self, double degrees) -> bool"""
        return _AriaPy.ArRVisionPTZ_panRel(self, *args)

    def tilt(self, *args):
        """tilt(self, double degrees) -> bool"""
        return _AriaPy.ArRVisionPTZ_tilt(self, *args)

    def tiltRel(self, *args):
        """tiltRel(self, double degrees) -> bool"""
        return _AriaPy.ArRVisionPTZ_tiltRel(self, *args)

    def panTilt(self, *args):
        """panTilt(self, double degreesPan, double degreesTilt) -> bool"""
        return _AriaPy.ArRVisionPTZ_panTilt(self, *args)

    def panTiltRel(self, *args):
        """panTiltRel(self, double degreesPan, double degreesTilt) -> bool"""
        return _AriaPy.ArRVisionPTZ_panTiltRel(self, *args)
    ...
    def getPan(self):
        """getPan(self) -> double"""
        return _AriaPy.ArRVisionPTZ_getPan(self)

    def getTilt(self):
        """getTilt(self) -> double"""
        return _AriaPy.ArRVisionPTZ_getTilt(self)
    ...
    def getMaxPosPan(self):
        """getMaxPosPan(self) -> double"""
        return _AriaPy.ArRVisionPTZ_getMaxPosPan(self)

    def getMaxNegPan(self):
        """getMaxNegPan(self) -> double"""
        return _AriaPy.ArRVisionPTZ_getMaxNegPan(self)

    def getMaxPosTilt(self):
        """getMaxPosTilt(self) -> double"""
        return _AriaPy.ArRVisionPTZ_getMaxPosTilt(self)

    def getMaxNegTilt(self):
        """getMaxNegTilt(self) -> double"""
        return _AriaPy.ArRVisionPTZ_getMaxNegTilt(self)

    def getMaxZoom(self):
        """getMaxZoom(self) -> int"""
        return _AriaPy.ArRVisionPTZ_getMaxZoom(self)

    def getMinZoom(self):
        """getMinZoom(self) -> int"""
        return _AriaPy.ArRVisionPTZ_getMinZoom(self)
...
class ArSerialConnection(ArDeviceConnection):
    ...
    def __init__(self): 
        ...
        this = _AriaPy.new_ArSerialConnection()
        try: self.this.append(this)
        except: self.this = this
...
class ArSick(ArLMS2xx):
    ...
    __swig_setmethods__ = {}
    for _s in [ArLMS2xx]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArSick, name, value)
    __swig_getmethods__ = {}
    for _s in [ArLMS2xx]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ArSick, name)
    __repr__ = _swig_repr
    def __init__(self, currentBufferSize = 361, cumulativeBufferSize = 0, 
    name = "laser", addAriaExitCB = True, isSecondLaser = False): 
        """
        ...
        """
        this = _AriaPy.new_ArSick(currentBufferSize, cumulativeBufferSize, name, addAriaExitCB, 
    isSecondLaser)
        try: self.this.append(this)
        except: self.this = this
    ...
    def tryingToConnect(self):
        ...
        return _AriaPy.ArSick_tryingToConnect(self)

    def runOnRobot(self):
        """runOnRobot(self) -> bool"""
        return _AriaPy.ArSick_runOnRobot(self)

    def configure(self, *args):
        """
        configure(self, bool useSim = False, bool powerControl = True, bool laserFlipped = False, 
            BaudRate baud = BAUD38400, 
            Degrees deg = DEGREES180, Increment incr = INCREMENT_ONE)
        configure(self, bool useSim = False, bool powerControl = True, bool laserFlipped = False, 
            BaudRate baud = BAUD38400, 
        ...
        configure(self)
        """
        return _AriaPy.ArSick_configure(self, *args)

    def configureShort(self, *args):
        """
        ...
        configureShort(self)
        """
        return _AriaPy.ArSick_configureShort(self, *args)

    def setRangeInformation(self, *args):
        """
        ...
        """
        return _AriaPy.ArSick_setRangeInformation(self, *args)

    def isUsingSim(self):
        """isUsingSim(self) -> bool"""
        return _AriaPy.ArSick_isUsingSim(self)

    def isControllingPower(self):
        """isControllingPower(self) -> bool"""
        return _AriaPy.ArSick_isControllingPower(self)

    def isLaserFlipped(self):
        """isLaserFlipped(self) -> bool"""
        return _AriaPy.ArSick_isLaserFlipped(self)

    def getDegrees(self):
        """getDegrees(self) -> Degrees"""
        return _AriaPy.ArSick_getDegrees(self)

    def getBits(self):
        """getBits(self) -> Bits"""
        return _AriaPy.ArSick_getBits(self)

    def getUnits(self):
        """getUnits(self) -> Units"""
        return _AriaPy.ArSick_getUnits(self)

    def setIsUsingSim(self, *args):
        """setIsUsingSim(self, bool usingSim)"""
        return _AriaPy.ArSick_setIsUsingSim(self, *args)

    def setIsControllingPower(self, *args):
        """setIsControllingPower(self, bool controlPower)"""
        return _AriaPy.ArSick_setIsControllingPower(self, *args)

    def setIsLaserFlipped(self, *args):
        """setIsLaserFlipped(self, bool laserFlipped)"""
        return _AriaPy.ArSick_setIsLaserFlipped(self, *args)

    def setFilterCumulativeCleanDist(self, *args):
        """setFilterCumulativeCleanDist(self, double dist)"""
        return _AriaPy.ArSick_setFilterCumulativeCleanDist(self, *args)

    def getFilterCumulativeCleanDist(self):
        """getFilterCumulativeCleanDist(self) -> double"""
        return _AriaPy.ArSick_getFilterCumulativeCleanDist(self)

    def setFilterCleanCumulativeInterval(self, *args):
        """setFilterCleanCumulativeInterval(self, int milliSeconds)"""
        return _AriaPy.ArSick_setFilterCleanCumulativeInterval(self, *args)

    def getFilterCleanCumulativeInterval(self):
        """getFilterCleanCumulativeInterval(self) -> int"""
        return _AriaPy.ArSick_getFilterCleanCumulativeInterval(self)

    def setFilterCumulativeNearDist(self, *args):
        """setFilterCumulativeNearDist(self, double dist)"""
        return _AriaPy.ArSick_setFilterCumulativeNearDist(self, *args)

    def getFilterCumulativeNearDist(self):
        """getFilterCumulativeNearDist(self) -> double"""
        return _AriaPy.ArSick_getFilterCumulativeNearDist(self)

    def setFilterNearDist(self, *args):
        """setFilterNearDist(self, double dist)"""
        return _AriaPy.ArSick_setFilterNearDist(self, *args)

    def getFilterNearDist(self):
        """getFilterNearDist(self) -> double"""
        return _AriaPy.ArSick_getFilterNearDist(self)

    def setFilterCumulativeInsertMaxDist(self, *args):
        """setFilterCumulativeInsertMaxDist(self, double dist)"""
        return _AriaPy.ArSick_setFilterCumulativeInsertMaxDist(self, *args)

    def getFilterCumulativeInsertMaxDist(self):
        """getFilterCumulativeInsertMaxDist(self) -> double"""
        return _AriaPy.ArSick_getFilterCumulativeInsertMaxDist(self)

    def getMinRange(self):
        """getMinRange(self) -> unsigned int"""
        return _AriaPy.ArSick_getMinRange(self)

    def setMinRange(self, *args):
        """setMinRange(self, unsigned int minRange)"""
        return _AriaPy.ArSick_setMinRange(self, *args)

    def setFilterCumulativeMaxDist(self, *args):
        """setFilterCumulativeMaxDist(self, double dist)"""
        return _AriaPy.ArSick_setFilterCumulativeMaxDist(self, *args)

    def getFilterCumulativeMaxDist(self):
        """getFilterCumulativeMaxDist(self) -> double"""
        return _AriaPy.ArSick_getFilterCumulativeMaxDist(self)

    def setFilterCumulativeMaxAge(self, *args):
        """setFilterCumulativeMaxAge(self, int seconds)"""
        return _AriaPy.ArSick_setFilterCumulativeMaxAge(self, *args)

    def getFilterCumulativeMaxAge(self):
        """getFilterCumulativeMaxAge(self) -> int"""
        return _AriaPy.ArSick_getFilterCumulativeMaxAge(self)

    def getSickPacCount(self):
        """getSickPacCount(self) -> int"""
        return _AriaPy.ArSick_getSickPacCount(self)
    ...
    def addConnectCB(self, *args):
        ...
        addConnectCB(self, ArFunctor functor)
        """
        return _AriaPy.ArSick_addConnectCB(self, *args)

    def remConnectCB(self, *args):
        """remConnectCB(self, ArFunctor functor)"""
        return _AriaPy.ArSick_remConnectCB(self, *args)
    ...
    def addFailedConnectCB(self, *args):
        ...
        addFailedConnectCB(self, ArFunctor functor)
        """
        return _AriaPy.ArSick_addFailedConnectCB(self, *args)

    def remFailedConnectCB(self, *args):
        """remFailedConnectCB(self, ArFunctor functor)"""
        return _AriaPy.ArSick_remFailedConnectCB(self, *args)
    ...
    def addDisconnectNormallyCB(self, *args):
        ...
        addDisconnectNormallyCB(self, ArFunctor functor)
        """
        return _AriaPy.ArSick_addDisconnectNormallyCB(self, *args)

    def remDisconnectNormallyCB(self, *args):
        """remDisconnectNormallyCB(self, ArFunctor functor)"""
        return _AriaPy.ArSick_remDisconnectNormallyCB(self, *args)
    ...
    def addDisconnectOnErrorCB(self, *args):
        ...
        addDisconnectOnErrorCB(self, ArFunctor functor)
        """
        return _AriaPy.ArSick_addDisconnectOnErrorCB(self, *args)

    def remDisconnectOnErrorCB(self, *args):
        """remDisconnectOnErrorCB(self, ArFunctor functor)"""
        return _AriaPy.ArSick_remDisconnectOnErrorCB(self, *args)

    def addDataCB(self, *args):
        """
        addDataCB(self, ArFunctor functor, Pos position = LAST)
        addDataCB(self, ArFunctor functor)
        """
        return _AriaPy.ArSick_addDataCB(self, *args)

    def remDataCB(self, *args):
        """remDataCB(self, ArFunctor functor)"""
        return _AriaPy.ArSick_remDataCB(self, *args)

    def setConnectionTimeoutTime(self, *args):
        """setConnectionTimeoutTime(self, int secs)"""
        return _AriaPy.ArSick_setConnectionTimeoutTime(self, *args)

    def getConnectionTimeoutTime(self):
        """getConnectionTimeoutTime(self) -> int"""
        return _AriaPy.ArSick_getConnectionTimeoutTime(self)
...
class ArSignalHandler(ArASyncTask):
    ...
    if _newclass:createHandlerNonThreaded = staticmethod(createHandlerNonThreaded)
    __swig_getmethods__["createHandlerNonThreaded"] = lambda x: createHandlerNonThreaded
    def createHandlerThreaded():
        """createHandlerThreaded()"""
        return _AriaPy.ArSignalHandler_createHandlerThreaded()

    if _newclass:createHandlerThreaded = staticmethod(createHandlerThreaded)
    __swig_getmethods__["createHandlerThreaded"] = lambda x: createHandlerThreaded
    def blockCommon():
        """blockCommon()"""
        return _AriaPy.ArSignalHandler_blockCommon()

    if _newclass:blockCommon = staticmethod(blockCommon)
    __swig_getmethods__["blockCommon"] = lambda x: blockCommon
    def unblockAll():
        """unblockAll()"""
        return _AriaPy.ArSignalHandler_unblockAll()

    if _newclass:unblockAll = staticmethod(unblockAll)
    __swig_getmethods__["unblockAll"] = lambda x: unblockAll
    def block(*args):
        """block(Signal sig)"""
        return _AriaPy.ArSignalHandler_block(*args)

    if _newclass:block = staticmethod(block)
    __swig_getmethods__["block"] = lambda x: block
    def unblock(*args):
        """unblock(Signal sig)"""
        return _AriaPy.ArSignalHandler_unblock(*args)

    if _newclass:unblock = staticmethod(unblock)
    __swig_getmethods__["unblock"] = lambda x: unblock
    def handle(*args):
        """handle(Signal sig)"""
        return _AriaPy.ArSignalHandler_handle(*args)

    if _newclass:handle = staticmethod(handle)
    __swig_getmethods__["handle"] = lambda x: handle
    def unhandle(*args):
        """unhandle(Signal sig)"""
        return _AriaPy.ArSignalHandler_unhandle(*args)

    if _newclass:unhandle = staticmethod(unhandle)
    __swig_getmethods__["unhandle"] = lambda x: unhandle
    def addHandlerCB(*args):
        """addHandlerCB(ArFunctor1_Int func, Pos position)"""
        return _AriaPy.ArSignalHandler_addHandlerCB(*args)

    if _newclass:addHandlerCB = staticmethod(addHandlerCB)
    __swig_getmethods__["addHandlerCB"] = lambda x: addHandlerCB
    def delHandlerCB(*args):
        """delHandlerCB(ArFunctor1_Int func)"""
        return _AriaPy.ArSignalHandler_delHandlerCB(*args)

    if _newclass:delHandlerCB = staticmethod(delHandlerCB)
    __swig_getmethods__["delHandlerCB"] = lambda x: delHandlerCB
    def delAllHandlerCBs():
        """delAllHandlerCBs()"""
        return _AriaPy.ArSignalHandler_delAllHandlerCBs()

    if _newclass:delAllHandlerCBs = staticmethod(delAllHandlerCBs)
    __swig_getmethods__["delAllHandlerCBs"] = lambda x: delAllHandlerCBs
    def getHandler():
        """getHandler() -> ArSignalHandler"""
        return _AriaPy.ArSignalHandler_getHandler()

    if _newclass:getHandler = staticmethod(getHandler)
    __swig_getmethods__["getHandler"] = lambda x: getHandler
    def nameSignal(*args):
        """nameSignal(int sig) -> char"""
        return _AriaPy.ArSignalHandler_nameSignal(*args)

    if _newclass:nameSignal = staticmethod(nameSignal)
    __swig_getmethods__["nameSignal"] = lambda x: nameSignal
    def blockCommonThisThread():
        """blockCommonThisThread()"""
        return _AriaPy.ArSignalHandler_blockCommonThisThread()

    if _newclass:blockCommonThisThread = staticmethod(blockCommonThisThread)
    __swig_getmethods__["blockCommonThisThread"] = lambda x: blockCommonThisThread
    def blockAllThisThread():
        """blockAllThisThread()"""
        return _AriaPy.ArSignalHandler_blockAllThisThread()

    if _newclass:blockAllThisThread = staticmethod(blockAllThisThread)
    __swig_getmethods__["blockAllThisThread"] = lambda x: blockAllThisThread
    ...
    if _newclass:signalCB = staticmethod(signalCB)
    __swig_getmethods__["signalCB"] = lambda x: signalCB
    def logThread():
        """logThread()"""
        return _AriaPy.ArSignalHandler_logThread()

    if _newclass:logThread = staticmethod(logThread)
    __swig_getmethods__["logThread"] = lambda x: logThread
...
class ArSimpleConnector(_object):
...
class ArSocket(_object):
    ...
    if _newclass:shutdown = staticmethod(shutdown)
    __swig_getmethods__["shutdown"] = lambda x: shutdown
    ...
    if _newclass:ourInitialized = _swig_property(_AriaPy.ArSocket_ourInitialized_get, _AriaPy.ArSocket_ourInitialized_set)
    def copy(self, *args):
        """
    ...
    if _newclass:hostAddr = staticmethod(hostAddr)
    __swig_getmethods__["hostAddr"] = lambda x: hostAddr
    def addrHost(*args):
        """addrHost(in_addr addr, char host) -> bool"""
        return _AriaPy.ArSocket_addrHost(*args)

    if _newclass:addrHost = staticmethod(addrHost)
    __swig_getmethods__["addrHost"] = lambda x: addrHost
    def getHostName():
        """getHostName() -> string"""
        return _AriaPy.ArSocket_getHostName()

    if _newclass:getHostName = staticmethod(getHostName)
    __swig_getmethods__["getHostName"] = lambda x: getHostName
    ...
    if _newclass:inToA = staticmethod(inToA)
    __swig_getmethods__["inToA"] = lambda x: inToA
    def sockAddrLen():
        """sockAddrLen() -> size_t"""
        return _AriaPy.ArSocket_sockAddrLen()

    if _newclass:sockAddrLen = staticmethod(sockAddrLen)
    __swig_getmethods__["sockAddrLen"] = lambda x: sockAddrLen
    def maxHostNameLen():
        """maxHostNameLen() -> size_t"""
        return _AriaPy.ArSocket_maxHostNameLen()

    if _newclass:maxHostNameLen = staticmethod(maxHostNameLen)
    __swig_getmethods__["maxHostNameLen"] = lambda x: maxHostNameLen
    def hostToNetOrder(*args):
        """hostToNetOrder(int i) -> unsigned int"""
        return _AriaPy.ArSocket_hostToNetOrder(*args)

    if _newclass:hostToNetOrder = staticmethod(hostToNetOrder)
    __swig_getmethods__["hostToNetOrder"] = lambda x: hostToNetOrder
    def netToHostOrder(*args):
        """netToHostOrder(int i) -> unsigned int"""
        return _AriaPy.ArSocket_netToHostOrder(*args)

    if _newclass:netToHostOrder = staticmethod(netToHostOrder)
    __swig_getmethods__["netToHostOrder"] = lambda x: netToHostOrder
...
class ArSonarAutoDisabler(_object):
...
class ArSonyPTZ(ArPTZ):
    ...
    def pan(self, *args):
        """pan(self, double degrees) -> bool"""
        return _AriaPy.ArSonyPTZ_pan(self, *args)

    def panRel(self, *args):
        """panRel(self, double degrees) -> bool"""
        return _AriaPy.ArSonyPTZ_panRel(self, *args)

    def tilt(self, *args):
        """tilt(self, double degrees) -> bool"""
        return _AriaPy.ArSonyPTZ_tilt(self, *args)

    def tiltRel(self, *args):
        """tiltRel(self, double degrees) -> bool"""
        return _AriaPy.ArSonyPTZ_tiltRel(self, *args)

    def panTilt(self, *args):
        """panTilt(self, double degreesPan, double degreesTilt) -> bool"""
        return _AriaPy.ArSonyPTZ_panTilt(self, *args)

    def panTiltRel(self, *args):
        """panTiltRel(self, double degreesPan, double degreesTilt) -> bool"""
        return _AriaPy.ArSonyPTZ_panTiltRel(self, *args)
    ...
    def getPan(self):
        """getPan(self) -> double"""
        return _AriaPy.ArSonyPTZ_getPan(self)

    def getTilt(self):
        """getTilt(self) -> double"""
        return _AriaPy.ArSonyPTZ_getTilt(self)
    ...
    def getMaxPosPan(self):
        """getMaxPosPan(self) -> double"""
        return _AriaPy.ArSonyPTZ_getMaxPosPan(self)

    def getMaxNegPan(self):
        """getMaxNegPan(self) -> double"""
        return _AriaPy.ArSonyPTZ_getMaxNegPan(self)

    def getMaxPosTilt(self):
        """getMaxPosTilt(self) -> double"""
        return _AriaPy.ArSonyPTZ_getMaxPosTilt(self)

    def getMaxNegTilt(self):
        """getMaxNegTilt(self) -> double"""
        return _AriaPy.ArSonyPTZ_getMaxNegTilt(self)

    def getMaxZoom(self):
        """getMaxZoom(self) -> int"""
        return _AriaPy.ArSonyPTZ_getMaxZoom(self)

    def getMinZoom(self):
        """getMinZoom(self) -> int"""
        return _AriaPy.ArSonyPTZ_getMinZoom(self)
...
class ArSoundPlayer(_object):
    ...
    if _newclass:playWavFile = staticmethod(playWavFile)
    __swig_getmethods__["playWavFile"] = lambda x: playWavFile
    def playNativeFile(*args):
        """playNativeFile(char filename, char params) -> bool"""
        return _AriaPy.ArSoundPlayer_playNativeFile(*args)

    if _newclass:playNativeFile = staticmethod(playNativeFile)
    __swig_getmethods__["playNativeFile"] = lambda x: playNativeFile
    def stopPlaying():
        """stopPlaying()"""
        return _AriaPy.ArSoundPlayer_stopPlaying()

    if _newclass:stopPlaying = staticmethod(stopPlaying)
    __swig_getmethods__["stopPlaying"] = lambda x: stopPlaying
    ...
    if _newclass:getPlayWavFileCallback = staticmethod(getPlayWavFileCallback)
    __swig_getmethods__["getPlayWavFileCallback"] = lambda x: getPlayWavFileCallback
    def getStopPlayingCallback():
        """getStopPlayingCallback() -> ArFunctor"""
        return _AriaPy.ArSoundPlayer_getStopPlayingCallback()

    if _newclass:getStopPlayingCallback = staticmethod(getStopPlayingCallback)
    __swig_getmethods__["getStopPlayingCallback"] = lambda x: getStopPlayingCallback
    def playSoundPCM16(*args):
        """playSoundPCM16(char data, int numSamples) -> bool"""
        return _AriaPy.ArSoundPlayer_playSoundPCM16(*args)

    if _newclass:playSoundPCM16 = staticmethod(playSoundPCM16)
    __swig_getmethods__["playSoundPCM16"] = lambda x: playSoundPCM16
    def __init__(self): 
...
class ArStringInfoGroup(_object):
...
class ArSystemStatus(_object):
    ...
    __repr__ = _swig_repr
    def startPeriodicUpdate(refreshFrequency = 5000):
        """
        startPeriodicUpdate(int refreshFrequency = 5000)
        startPeriodicUpdate()
        """
        return _AriaPy.ArSystemStatus_startPeriodicUpdate(refreshFrequency)

    if _newclass:startPeriodicUpdate = staticmethod(startPeriodicUpdate)
    __swig_getmethods__["startPeriodicUpdate"] = lambda x: startPeriodicUpdate
    def stopPeriodicUpdate():
        """stopPeriodicUpdate()"""
        return _AriaPy.ArSystemStatus_stopPeriodicUpdate()

    if _newclass:stopPeriodicUpdate = staticmethod(stopPeriodicUpdate)
    __swig_getmethods__["stopPeriodicUpdate"] = lambda x: stopPeriodicUpdate
    ...
    if _newclass:runRefreshThread = staticmethod(runRefreshThread)
    __swig_getmethods__["runRefreshThread"] = lambda x: runRefreshThread
    def getCPU():
        """getCPU() -> double"""
        return _AriaPy.ArSystemStatus_getCPU()

    if _newclass:getCPU = staticmethod(getCPU)
    __swig_getmethods__["getCPU"] = lambda x: getCPU
    def getCPUPercent():
        """getCPUPercent() -> double"""
        return _AriaPy.ArSystemStatus_getCPUPercent()

    if _newclass:getCPUPercent = staticmethod(getCPUPercent)
    __swig_getmethods__["getCPUPercent"] = lambda x: getCPUPercent
    def getCPUPercentAsString():
        """getCPUPercentAsString() -> string"""
        return _AriaPy.ArSystemStatus_getCPUPercentAsString()

    if _newclass:getCPUPercentAsString = staticmethod(getCPUPercentAsString)
    __swig_getmethods__["getCPUPercentAsString"] = lambda x: getCPUPercentAsString
    def getUptime():
        """getUptime() -> unsigned long"""
        return _AriaPy.ArSystemStatus_getUptime()

    if _newclass:getUptime = staticmethod(getUptime)
    __swig_getmethods__["getUptime"] = lambda x: getUptime
    def getUptimeHours():
        """getUptimeHours() -> double"""
        return _AriaPy.ArSystemStatus_getUptimeHours()

    if _newclass:getUptimeHours = staticmethod(getUptimeHours)
    __swig_getmethods__["getUptimeHours"] = lambda x: getUptimeHours
    def getUptimeHoursAsString():
        """getUptimeHoursAsString() -> string"""
        return _AriaPy.ArSystemStatus_getUptimeHoursAsString()

    if _newclass:getUptimeHoursAsString = staticmethod(getUptimeHoursAsString)
    __swig_getmethods__["getUptimeHoursAsString"] = lambda x: getUptimeHoursAsString
    def getCPUPercentFunctor():
        """getCPUPercentFunctor() -> ArRetFunctor_Double"""
        return _AriaPy.ArSystemStatus_getCPUPercentFunctor()

    if _newclass:getCPUPercentFunctor = staticmethod(getCPUPercentFunctor)
    __swig_getmethods__["getCPUPercentFunctor"] = lambda x: getCPUPercentFunctor
    def getUptimeHoursFunctor():
        """getUptimeHoursFunctor() -> ArRetFunctor_Double"""
        return _AriaPy.ArSystemStatus_getUptimeHoursFunctor()

    if _newclass:getUptimeHoursFunctor = staticmethod(getUptimeHoursFunctor)
    __swig_getmethods__["getUptimeHoursFunctor"] = lambda x: getUptimeHoursFunctor
    def getWirelessLinkQuality():
        """getWirelessLinkQuality() -> int"""
        return _AriaPy.ArSystemStatus_getWirelessLinkQuality()

    if _newclass:getWirelessLinkQuality = staticmethod(getWirelessLinkQuality)
    __swig_getmethods__["getWirelessLinkQuality"] = lambda x: getWirelessLinkQuality
    def getWirelessLinkSignal():
        """getWirelessLinkSignal() -> int"""
        return _AriaPy.ArSystemStatus_getWirelessLinkSignal()

    if _newclass:getWirelessLinkSignal = staticmethod(getWirelessLinkSignal)
    __swig_getmethods__["getWirelessLinkSignal"] = lambda x: getWirelessLinkSignal
    def getWirelessLinkNoise():
        """getWirelessLinkNoise() -> int"""
        return _AriaPy.ArSystemStatus_getWirelessLinkNoise()

    if _newclass:getWirelessLinkNoise = staticmethod(getWirelessLinkNoise)
    __swig_getmethods__["getWirelessLinkNoise"] = lambda x: getWirelessLinkNoise
    def getWirelessDiscardedPackets():
        """getWirelessDiscardedPackets() -> int"""
        return _AriaPy.ArSystemStatus_getWirelessDiscardedPackets()

    if _newclass:getWirelessDiscardedPackets = staticmethod(getWirelessDiscardedPackets)
    __swig_getmethods__["getWirelessDiscardedPackets"] = lambda x: getWirelessDiscardedPackets
    ...
    if _newclass:getWirelessDiscardedPacketsBecauseNetConflict = staticmethod(getWirelessDiscardedPacketsBecauseNetConflict)
    __swig_getmethods__["getWirelessDiscardedPacketsBecauseNetConflict"] = lambda x: getWirelessDiscardedPacketsBecauseNetConflict
    ...
    if _newclass:getWirelessLinkQualityFunctor = staticmethod(getWirelessLinkQualityFunctor)
    __swig_getmethods__["getWirelessLinkQualityFunctor"] = lambda x: getWirelessLinkQualityFunctor
    ...
    if _newclass:getWirelessLinkNoiseFunctor = staticmethod(getWirelessLinkNoiseFunctor)
    __swig_getmethods__["getWirelessLinkNoiseFunctor"] = lambda x: getWirelessLinkNoiseFunctor
    ...
    if _newclass:getWirelessLinkSignalFunctor = staticmethod(getWirelessLinkSignalFunctor)
    __swig_getmethods__["getWirelessLinkSignalFunctor"] = lambda x: getWirelessLinkSignalFunctor
    def invalidate():
        """invalidate()"""
        return _AriaPy.ArSystemStatus_invalidate()

    if _newclass:invalidate = staticmethod(invalidate)
    __swig_getmethods__["invalidate"] = lambda x: invalidate
    def refresh():
        """refresh()"""
        return _AriaPy.ArSystemStatus_refresh()

    if _newclass:refresh = staticmethod(refresh)
    __swig_getmethods__["refresh"] = lambda x: refresh
    def __init__(self): 
...
def ArSystemStatus_startPeriodicUpdate(refreshFrequency = 5000):
  """
    startPeriodicUpdate(int refreshFrequency = 5000)
...
class ArCompassConnector(_object):
...
class ArTCMCompassDirect(ArTCM2):
    ...
    __swig_setmethods__ = {}
    for _s in [ArTCM2]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArTCMCompassDirect, name, value)
    __swig_getmethods__ = {}
    for _s in [ArTCM2]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    def __init__(self, *args): 
        ...
        __init__(self, char serialPortName = "COM4") -> ArTCMCompassDirect
...
class ArVCC4(ArPTZ):
    ...
    def pan(self, *args):
        """pan(self, double deg) -> bool"""
        return _AriaPy.ArVCC4_pan(self, *args)

    def panRel(self, *args):
        """panRel(self, double deg) -> bool"""
        return _AriaPy.ArVCC4_panRel(self, *args)

    def tilt(self, *args):
        """tilt(self, double deg) -> bool"""
        return _AriaPy.ArVCC4_tilt(self, *args)

    def tiltRel(self, *args):
        """tiltRel(self, double deg) -> bool"""
        return _AriaPy.ArVCC4_tiltRel(self, *args)

    def panTiltRel(self, *args):
        """panTiltRel(self, double pdeg, double tdeg) -> bool"""
        return _AriaPy.ArVCC4_panTiltRel(self, *args)

    def getMaxPosPan(self):
        """getMaxPosPan(self) -> double"""
        return _AriaPy.ArVCC4_getMaxPosPan(self)

    def getMaxNegPan(self):
        """getMaxNegPan(self) -> double"""
        return _AriaPy.ArVCC4_getMaxNegPan(self)

    def getMaxPosTilt(self):
        """getMaxPosTilt(self) -> double"""
        return _AriaPy.ArVCC4_getMaxPosTilt(self)

    def getMaxNegTilt(self):
        """getMaxNegTilt(self) -> double"""
        return _AriaPy.ArVCC4_getMaxNegTilt(self)
    ...
    def panTilt(self, *args):
        """panTilt(self, double pdeg, double tdeg) -> bool"""
        return _AriaPy.ArVCC4_panTilt(self, *args)
    ...
    def getPan(self):
        """getPan(self) -> double"""
        return _AriaPy.ArVCC4_getPan(self)

    def getTilt(self):
        """getTilt(self) -> double"""
        return _AriaPy.ArVCC4_getTilt(self)
...
class Aria(_object):
    ...
    if _newclass:uninit = staticmethod(uninit)
    __swig_getmethods__["uninit"] = lambda x: uninit
    def addInitCallBack(*args):
        """addInitCallBack(ArFunctor cb, Pos position)"""
        return _AriaPy.Aria_addInitCallBack(*args)

    if _newclass:addInitCallBack = staticmethod(addInitCallBack)
    __swig_getmethods__["addInitCallBack"] = lambda x: addInitCallBack
    def addUninitCallBack(*args):
        """addUninitCallBack(ArFunctor cb, Pos position)"""
        return _AriaPy.Aria_addUninitCallBack(*args)

    if _newclass:addUninitCallBack = staticmethod(addUninitCallBack)
    __swig_getmethods__["addUninitCallBack"] = lambda x: addUninitCallBack
    def shutdown():
        """shutdown()"""
    ...
    if _newclass:exit = staticmethod(exit)
    __swig_getmethods__["exit"] = lambda x: exit
    def getRunning():
        """getRunning() -> bool"""
        return _AriaPy.Aria_getRunning()

    if _newclass:getRunning = staticmethod(getRunning)
    __swig_getmethods__["getRunning"] = lambda x: getRunning
    def setDirectory(*args):
        """setDirectory(char directory)"""
        return _AriaPy.Aria_setDirectory(*args)

    if _newclass:setDirectory = staticmethod(setDirectory)
    __swig_getmethods__["setDirectory"] = lambda x: setDirectory
    def getDirectory():
        """getDirectory() -> char"""
    ...
    if _newclass:parseArgs = staticmethod(parseArgs)
    __swig_getmethods__["parseArgs"] = lambda x: parseArgs
    def logOptions():
        """logOptions()"""
        return _AriaPy.Aria_logOptions()

    if _newclass:logOptions = staticmethod(logOptions)
    __swig_getmethods__["logOptions"] = lambda x: logOptions
    def setKeyHandler(*args):
        """setKeyHandler(ArKeyHandler keyHandler)"""
        return _AriaPy.Aria_setKeyHandler(*args)

    if _newclass:setKeyHandler = staticmethod(setKeyHandler)
    __swig_getmethods__["setKeyHandler"] = lambda x: setKeyHandler
    def getKeyHandler():
        """getKeyHandler() -> ArKeyHandler"""
        return _AriaPy.Aria_getKeyHandler()

    if _newclass:getKeyHandler = staticmethod(getKeyHandler)
    __swig_getmethods__["getKeyHandler"] = lambda x: getKeyHandler
    def setJoyHandler(*args):
        """setJoyHandler(ArJoyHandler joyHandler)"""
        return _AriaPy.Aria_setJoyHandler(*args)

    if _newclass:setJoyHandler = staticmethod(setJoyHandler)
    __swig_getmethods__["setJoyHandler"] = lambda x: setJoyHandler
    def getJoyHandler():
        """getJoyHandler() -> ArJoyHandler"""
        return _AriaPy.Aria_getJoyHandler()

    if _newclass:getJoyHandler = staticmethod(getJoyHandler)
    __swig_getmethods__["getJoyHandler"] = lambda x: getJoyHandler
    ...
    if _newclass:addExitCallback = staticmethod(addExitCallback)
    __swig_getmethods__["addExitCallback"] = lambda x: addExitCallback
    def remExitCallback(*args):
        """remExitCallback(ArFunctor functor)"""
        return _AriaPy.Aria_remExitCallback(*args)

    if _newclass:remExitCallback = staticmethod(remExitCallback)
    __swig_getmethods__["remExitCallback"] = lambda x: remExitCallback
    ...
    if _newclass:setExitCallbacksLogLevel = staticmethod(setExitCallbacksLogLevel)
    __swig_getmethods__["setExitCallbacksLogLevel"] = lambda x: setExitCallbacksLogLevel
    ...
    if _newclass:exitOld = staticmethod(exitOld)
    __swig_getmethods__["exitOld"] = lambda x: exitOld
    def signalHandlerCB(*args):
        """signalHandlerCB(int sig)"""
        return _AriaPy.Aria_signalHandlerCB(*args)

    if _newclass:signalHandlerCB = staticmethod(signalHandlerCB)
    __swig_getmethods__["signalHandlerCB"] = lambda x: signalHandlerCB
    def callExitCallbacks():
        """callExitCallbacks()"""
        return _AriaPy.Aria_callExitCallbacks()

    if _newclass:callExitCallbacks = staticmethod(callExitCallbacks)
    __swig_getmethods__["callExitCallbacks"] = lambda x: callExitCallbacks
    ...
    if _newclass:addParseArgsCB = staticmethod(addParseArgsCB)
    __swig_getmethods__["addParseArgsCB"] = lambda x: addParseArgsCB
    def setParseArgLogLevel(*args):
        """setParseArgLogLevel(LogLevel level)"""
        return _AriaPy.Aria_setParseArgLogLevel(*args)

    if _newclass:setParseArgLogLevel = staticmethod(setParseArgLogLevel)
    __swig_getmethods__["setParseArgLogLevel"] = lambda x: setParseArgLogLevel
    ...
    if _newclass:addLogOptionsCB = staticmethod(addLogOptionsCB)
    __swig_getmethods__["addLogOptionsCB"] = lambda x: addLogOptionsCB
    ...
    if _newclass:deviceConnectionAddCreator = staticmethod(deviceConnectionAddCreator)
    __swig_getmethods__["deviceConnectionAddCreator"] = lambda x: deviceConnectionAddCreator
    def deviceConnectionGetTypes():
        """deviceConnectionGetTypes() -> char"""
        return _AriaPy.Aria_deviceConnectionGetTypes()

    if _newclass:deviceConnectionGetTypes = staticmethod(deviceConnectionGetTypes)
    __swig_getmethods__["deviceConnectionGetTypes"] = lambda x: deviceConnectionGetTypes
    ...
    if _newclass:deviceConnectionCreate = staticmethod(deviceConnectionCreate)
    __swig_getmethods__["deviceConnectionCreate"] = lambda x: deviceConnectionCreate
    ...
    if _newclass:setRobotJoyHandler = staticmethod(setRobotJoyHandler)
    __swig_getmethods__["setRobotJoyHandler"] = lambda x: setRobotJoyHandler
    def getRobotJoyHandler():
        """getRobotJoyHandler() -> ArRobotJoyHandler"""
        return _AriaPy.Aria_getRobotJoyHandler()

    if _newclass:getRobotJoyHandler = staticmethod(getRobotJoyHandler)
    __swig_getmethods__["getRobotJoyHandler"] = lambda x: getRobotJoyHandler
    def getConfig():
        """getConfig() -> ArConfig"""
        return _AriaPy.Aria_getConfig()

    if _newclass:getConfig = staticmethod(getConfig)
    __swig_getmethods__["getConfig"] = lambda x: getConfig
    def getInfoGroup():
        """getInfoGroup() -> ArStringInfoGroup"""
        return _AriaPy.Aria_getInfoGroup()

    if _newclass:getInfoGroup = staticmethod(getInfoGroup)
    __swig_getmethods__["getInfoGroup"] = lambda x: getInfoGroup
    def addRobot(*args):
        """addRobot(ArRobot robot)"""
        return _AriaPy.Aria_addRobot(*args)

    if _newclass:addRobot = staticmethod(addRobot)
    __swig_getmethods__["addRobot"] = lambda x: addRobot
    def delRobot(*args):
        """delRobot(ArRobot robot)"""
        return _AriaPy.Aria_delRobot(*args)

    if _newclass:delRobot = staticmethod(delRobot)
    __swig_getmethods__["delRobot"] = lambda x: delRobot
    def findRobot(*args):
        """findRobot(char name) -> ArRobot"""
        return _AriaPy.Aria_findRobot(*args)

    if _newclass:findRobot = staticmethod(findRobot)
    __swig_getmethods__["findRobot"] = lambda x: findRobot
    def getRobotList():
        """getRobotList() -> std::list<(p.ArRobot,std::allocator<(p.ArRobot)>)>"""
        return _AriaPy.Aria_getRobotList()

    if _newclass:getRobotList = staticmethod(getRobotList)
    __swig_getmethods__["getRobotList"] = lambda x: getRobotList
    def getMaxNumLasers():
        """getMaxNumLasers() -> int"""
        return _AriaPy.Aria_getMaxNumLasers()

    if _newclass:getMaxNumLasers = staticmethod(getMaxNumLasers)
    __swig_getmethods__["getMaxNumLasers"] = lambda x: getMaxNumLasers
    def setMaxNumLasers(*args):
        """setMaxNumLasers(int maxNumLasers)"""
        return _AriaPy.Aria_setMaxNumLasers(*args)

    if _newclass:setMaxNumLasers = staticmethod(setMaxNumLasers)
    __swig_getmethods__["setMaxNumLasers"] = lambda x: setMaxNumLasers
    ...
    if _newclass:laserAddCreator = staticmethod(laserAddCreator)
    __swig_getmethods__["laserAddCreator"] = lambda x: laserAddCreator
    def laserGetTypes():
        """laserGetTypes() -> char"""
        return _AriaPy.Aria_laserGetTypes()

    if _newclass:laserGetTypes = staticmethod(laserGetTypes)
    __swig_getmethods__["laserGetTypes"] = lambda x: laserGetTypes
    ...
    if _newclass:laserCreate = staticmethod(laserCreate)
    __swig_getmethods__["laserCreate"] = lambda x: laserCreate
    def __init__(self): 
        """__init__(self) -> Aria"""
...
class ArPyRetFunctor_Bool(ArRetFunctor_Bool,ArPyFunctor):
    ...
    __swig_setmethods__ = {}
    for _s in [ArRetFunctor_Bool,ArPyFunctor]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArPyRetFunctor_Bool, name, value)
    __swig_getmethods__ = {}
    for _s in [ArRetFunctor_Bool,ArPyFunctor]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class ArConfigArg_Bool(ArConfigArg):
    ...
    __swig_setmethods__ = {}
    for _s in [ArConfigArg]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArConfigArg_Bool, name, value)
    __swig_getmethods__ = {}
    for _s in [ArConfigArg]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
