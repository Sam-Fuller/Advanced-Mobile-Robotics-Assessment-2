...
public class ArClientBase extends ArASyncTask {
  ...
  public boolean blockingConnect(String host, int port, boolean print, String user, String password, String openOnIP) {
    return ArNetworkingJavaJNI.ArClientBase_blockingConnect__SWIG_0(swigCPtr, this, host, port, print, user, password, openOnIP);
  }

  public boolean blockingConnect(String host, int port, boolean print, String user, String password) {
    return ArNetworkingJavaJNI.ArClientBase_blockingConnect__SWIG_1(swigCPtr, this, host, port, print, user, password);
  }

  public boolean blockingConnect(String host, int port, boolean print, String user) {
    return ArNetworkingJavaJNI.ArClientBase_blockingConnect__SWIG_2(swigCPtr, this, host, port, print, user);
  }

  public boolean blockingConnect(String host, int port, boolean print) {
    return ArNetworkingJavaJNI.ArClientBase_blockingConnect__SWIG_3(swigCPtr, this, host, port, print);
  }
  ...
  public void setServerKey(String serverKey, boolean print) {
    ArNetworkingJavaJNI.ArClientBase_setServerKey__SWIG_0(swigCPtr, this, serverKey, print);
  }
  ...
  public boolean internalBlockingConnect(String host, int port, boolean print, String user, String password, ArSocket tcpSocket, String openOnIP) {
    return ArNetworkingJavaJNI.ArClientBase_internalBlockingConnect__SWIG_0(swigCPtr, this, host, port, print, user, password, ArSocket.getCPtr(tcpSocket), tcpSocket, openOnIP);
  }

  public boolean internalBlockingConnect(String host, int port, boolean print, String user, String password, ArSocket tcpSocket) {
    return ArNetworkingJavaJNI.ArClientBase_internalBlockingConnect__SWIG_1(swigCPtr, this, host, port, print, user, password, ArSocket.getCPtr(tcpSocket), tcpSocket);
  }

  public ArClientBase.NonBlockingConnectReturn internalNonBlockingConnectStart(String host, int port, boolean print, String user, String password, ArSocket tcpSocket, String openOnIP) {
    return ArClientBase.NonBlockingConnectReturn.swigToEnum(ArNetworkingJavaJNI.ArClientBase_internalNonBlockingConnectStart__SWIG_0(swigCPtr, this, host, port, print, user, password, ArSocket.getCPtr(tcpSocket), tcpSocket, openOnIP));
  }

  public ArClientBase.NonBlockingConnectReturn internalNonBlockingConnectStart(String host, int port, boolean print, String user, String password, ArSocket tcpSocket) {
    return ArClientBase.NonBlockingConnectReturn.swigToEnum(ArNetworkingJavaJNI.ArClientBase_internalNonBlockingConnectStart__SWIG_1(swigCPtr, this, host, port, print, user, password, ArSocket.getCPtr(tcpSocket), tcpSocket));
  }
